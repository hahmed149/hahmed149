...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Pc(e,t,n){return new qo({name:`SphericalGaussianBlur`,defines:{SAMPLES:yc,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},sigma:{value:0},mipInt:{value:0}},vertexShader:Lc(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Fc(){return new qo({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:Lc(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Ic(){return new qo({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Lc(),fragmentShader:`
	...
	`}var Rc=class extends Jt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new $i(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
	...
	if ( coord.x >= 1.0 ) {
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
				...
				}`})}};Pd.BlurDirectionX=new U(1,0),Pd.BlurDirectionY=new U(0,1);var Fd={name:`OutputShader`,uniforms:{tDiffuse:{value:null},toneMappingExposure:{value:1}},vertexShader:`
		precision highp float;
		...
		}`},Id=class extends wd{constructor(){super(),this.isOutputPass=!0,this.uniforms=Wo.clone(Fd.uniforms),this.material=new Jo({name:Fd.name,uniforms:this.uniforms,vertexShader:Fd.vertexShader,fragmentShader:Fd.fragmentShader}),this._fsQuad=new Dd(this.material),this._outputColorSpace=null,this._toneMapping=null}render(e,t,n){this.uniforms.tDiffuse.value=n.texture,this.uniforms.toneMappingExposure.value=e.toneMappingExposure,(this._outputColorSpace!==e.outputColorSpace||this._toneMapping!==e.toneMapping)&&(this._outputColorSpace=e.outputColorSpace,this._toneMapping=e.toneMapping,this.material.defines={},Ft.getTransfer(this._outputColorSpace)===`srgb`&&(this.material.defines.SRGB_TRANSFER=``),this._toneMapping===1?this.material.defines.LINEAR_TONE_MAPPING=``:this._toneMapping===2?this.material.defines.REINHARD_TONE_MAPPING=``:this._toneMapping===3?this.material.defines.CINEON_TONE_MAPPING=``:this._toneMapping===4?this.material.defines.ACES_FILMIC_TONE_MAPPING=``:this._toneMapping===6?this.material.defines.AGX_TONE_MAPPING=``:this._toneMapping===7?this.material.defines.NEUTRAL_TONE_MAPPING=``:this._toneMapping===5&&(this.material.defines.CUSTOM_TONE_MAPPING=``),this.material.needsUpdate=!0),this.renderToScreen===!0?(e.setRenderTarget(null),this._fsQuad.render(e)):(e.setRenderTarget(t),this.clear&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),this._fsQuad.render(e))}dispose(){this.material.dispose(),this._fsQuad.dispose()}},Ld=t({NOW:()=>Bd,TIMELINE_START:()=>Vd,community:()=>Ud,finish:()=>Wd,person:()=>Rd,sections:()=>Hd,semesters:()=>zd,skills:()=>Gd}),Rd={name:`Hamza Ahmed`,role:`Staff Software Engineer, AI/ML Solutions Architect`,location:`Chicago, IL`,email:`hahmed149@outlook.com`,linkedin:`https://www.linkedin.com/in/hahmed149/`,github:`https://github.com/hahmed149`,summary:`Staff Software Engineer with 7+ years architecting enterprise AI-powered platforms and healthcare solutions: HIPAA-scoped AI agents on AWS Bedrock, RIS integrations, and the testing and migration foundations behind a medical imaging platform.`},zd=[{term:`Fall 2014`,date:`2014-08`,courses:[[`ECE 210`,`Intro to Electrical Engineering`],[`ENGL 100`,`Expository Writing 1`],[`MATH 220`,`Analytic Geometry & Calculus 1`],[`MC 110`,`Mass Communication in Society`],[`CIS 101`,`Intro to Computing Systems`],[`CIS 104`,`Intro to Word Processing Applications`]]},{term:`Spring 2015`,date:`2015-01`,courses:[[`CHM 210`,`Chemistry 1`],[`ECE 115`,`New Student Design Project`],[`ECE 241`,`Intro to Computer Engineering`],[`ECON 110`,`Principles of Macroeconomics`],[`MATH 221`,`Analytic Geometry & Calculus 2`]]},{term:`Summer 2015`,date:`2015-06`,courses:[[`PHYS 213`,`Engineering Physics 1`]]},{term:`Fall 2015`,date:`2015-08`,courses:[[`CIS 200`,`Programming Fundamentals`],[`ECE 410`,`Circuit Theory 1`],[`GEOL 100`,`Earth in Action`],[`MATH 240`,`Elementary Differential Equations`]]},{term:`Spring 2016`,date:`2016-01`,courses:[[`CIS 300`,`Data & Program Structures`],[`ECE 441`,`Design of Digital Systems`],[`ECE 511`,`Circuit Theory 2`],[`STAT 510`,`Introductory Probability & Statistics 1`],[`COMM 106`,`Public Speaking 1`]]},{term:`Fall 2016`,date:`2016-08`,honors:!0,courses:[[`ECE 431`,`Microcontrollers`],[`ECE 525`,`Electronics 1`],[`ENTRP 340`,`Intro to Entrepreneurship`],[`MANGT 420`,`Management Concepts`]]},{term:`Spring 2017`,date:`2017-01`,honors:!0,courses:[[`CIS 308`,`C/C++ Language Lab`],[`CIS 501`,`Software Architecture & Design`],[`ECE 540`,`Applied Scientific Computing`],[`GEOL 125`,`Natural Disasters`],[`MATH 510`,`Discrete Mathematics`]]},{term:`Fall 2017`,date:`2017-08`,honors:!0,courses:[[`ECE 542`,`Computer Networking`],[`ECE 643`,`Computer Engineering Design Lab`],[`ECE 649`,`Computer Design 1`],[`ENGL 415`,`Written Communication for Engineers`]]},{term:`Spring 2018`,date:`2018-01`,honors:!0,courses:[[`CIS 520`,`Operating Systems 1`],[`ECE 512`,`Linear Systems`],[`ECE 590`,`Senior Design Experience 1`],[`ECE 631`,`Microcomputer System Design`],[`ECE 645`,`Digital Electronics`],[`COMM 332`,`Communication & Technology`]]},{term:`Summer 2018`,date:`2018-06`,courses:[[`ECE 690`,`Problems in Electrical Engineering`]]},{term:`Fall 2018`,date:`2018-08`,courses:[[`ARCH 301`,`Appreciation of Architecture`],[`CIS 115`,`Intro to Computing Science`],[`CIS 301`,`Logical Foundations of Programming`],[`ECE 557`,`Electromagnetic Theory 1`],[`ECE 591`,`Senior Design Experience 2`]]}],Bd=`2026-09`,Vd=`2014-07`,Hd=[{id:`ksu`,slot:0,kind:`campus`,landmark:`campus`,start:`2014-08`,end:`2018-12`,years:`2014–2018`,company:`Kansas State University`,place:`Manhattan, KS`,title:`B.S. Computer Engineering, minor in Computer Science`,blurb:`Every course is a cone at its semester gate, on the date I took it.`,obstacles:[[`Hack K-State`,`Won Hack K-State (2017).`,`2017-02`],[`IEEE president`,`President of the IEEE student chapter (2018).`,`2018-01`],[`Graduated`,`Graduated with a B.S. in Computer Engineering and a minor in Computer Science (December 2018).`,`2018-12`]]},{id:`collegian`,slot:1,landmark:`press`,start:`2015-11`,end:`2018-12`,years:`2015–2018`,company:`Collegian Media Group`,place:`Manhattan, KS`,title:`IT Specialist, then IT Support Manager`,blurb:`IT Specialist, then IT Support Manager, in Manhattan, KS, while at K-State.`,obstacles:[[`100 Macs`,`Helped maintain a network of about 100 Mac workstations supporting 65+ faculty, staff, and students.`,`2016-02`],[`kstatecollegian.com`,`Redesigned and ran kstatecollegian.com, including traffic management.`,`2016-08`],[`Promoted`,`Promoted from IT Specialist to IT Support Manager.`,`2017-03`],[`Tech of the Year`,`Tech of the Year Award for outstanding technical performance (2017).`,`2017-06`,`award`],[`Hired a team`,`Interviewed and hired technical staff, oversaw the IT support team, and led its staff meetings.`,`2017-11`]]},{id:`softek`,slot:-1,landmark:`office`,start:`2018-05`,end:`2018-08`,years:`2018`,company:`Softek Illuminate`,place:`Overland Park, KS`,title:`Software Engineering Intern`,blurb:`Summer internship on the Insight application.`,obstacles:[[`Export / import`,`Built export and import components for the Insight application.`],[`French l10n`,`Added French localization to the Insight UI.`],[`Bug bash`,`Found and fixed bugs across the app to improve reliability.`]]},{id:`cerner`,slot:0,landmark:`cerner`,start:`2019-01`,end:`2020-09`,years:`2019–2020`,company:`Cerner Corporation`,place:`Kansas City, MO`,title:`Software Engineer`,blurb:`Patient flow and hospital capacity software on the CareAware platform.`,obstacles:[[`Capacity Mgmt`,`Led development of CareAware Capacity Management for patient flow and tracking.`],[`Command Center`,`Planned and built the CareAware Command Center Dashboard for real-time hospital operations.`],[`ML census model`,`Integrated an inpatient-census prediction model with the ML team to improve bed utilization.`],[`New Relic`,`Added New Relic monitoring and tracing, cutting time to resolve production issues.`],[`K8s + Spinnaker`,`Fixed critical bugs in internal orchestration tools and deployed services as Docker containers through Spinnaker and Kubernetes.`],[`Mentored 8`,`Mentored 8 engineers through DevAcademy, Cerner’s software boot camp.`],[`Night on the Town`,`Night on the Town Award for excellence in team collaboration (2019).`,`2019-06`,`award`]]},{id:`rxss`,slot:0,landmark:`rxss`,start:`2020-09`,end:`2025-12`,years:`2020–2025`,company:`Rx Savings Solutions / McKesson`,place:`Overland Park, KS`,title:`Software Engineer → Senior Software Engineer & Technical Lead`,blurb:`Prescription savings software. McKesson acquired RxSS in November 2022.`,obstacles:[[`Health plan viz`,`Built health plan data visualizations for the pharmacy support team.`],[`Nightly scans`,`Automated nightly scans to detect data changes and alert administrators.`],[`S3 + CloudFront CMS`,`Built a content management system on AWS S3 and CloudFront.`],[`Terraform`,`Introduced Terraform so application stacks deploy the same way in every environment.`],[`Azure AD SSO`,`Integrated Azure AD single sign-on.`],[`Hackathon 2nd`,`RxSS Hackathon (2022): prescriber fax automation. 2nd place.`,`2022-04`,`award`],[`Wolverine Award`,`Wolverine Award, peer-nominated for going the extra mile (2022).`,`2022-07`,`award`],[`Promoted`,`Promoted to Senior Software Engineer and Technical Lead (September 2022).`,`2022-09`],[`Private Label Mgr`,`Shipped Private Label Manager, saving an estimated 2,000 engineering hours.`],[`Unified Auth`,`Architected unified auth on Auth0 across the Member Portal, AdminRx, and mobile.`],[`MFA rollout`,`Designed MFA enrollment with feature-flagged rollout by user group.`],[`Zero downtime`,`Led a zero-downtime migration off legacy auth, with self-service password reset.`],[`Dev Academy`,`Founded and led Dev Academy, training new engineers in PHP and JavaScript.`],[`GitLab move`,`Moved Bitbucket to GitLab and rebuilt CI/CD and Terraform to cut deploy times.`],[`Vue 2 → 3`,`Led the Vue 2 to Vue 3 modernization.`],[`Spotlight Award`,`Employee Spotlight Award for a technical presentation at the CoverMyMeds conference.`,null,`award`],[`Demo mode`,`Built a MirageJS demo mode so sales could run custom demos.`],[`Release UI`,`Automated releases with a drag-and-drop UI so non-engineers could manage client customizations.`],[`Translations`,`Built a serverless app for centralized translation management across products.`]]},{id:`fluxpilot`,slot:1,landmark:`bess`,start:`2022-06`,end:`now`,years:`2022–now`,company:`Fluxpilot`,place:`Chicago, IL`,title:`Co-Founder`,blurb:`Software that sizes and lays out utility-scale battery energy storage projects.`,obstacles:[[`BESS sizing`,`Built the battery energy storage sizing framework.`],[`Electron app`,`Built the Electron desktop app and its release process.`],[`Local-first`,`Kept project data on the user’s machine by running the desktop app locally.`],[`AI sizing tools`,`Shipped a serverless web app with AI-assisted sizing tools.`],[`Faster bids`,`Made design iterations faster and repeatable, cutting engineering effort during bids.`]]},{id:`annovox`,slot:-1,landmark:`factory`,start:`2024-06`,end:`now`,years:`2024–now`,company:`Annovox AI`,place:`St. Joseph, MO`,title:`Chief Technology Officer`,blurb:`Turns expert video recordings into factory-floor training.`,obstacles:[[`AI work orders`,`Generated editing work orders from subject-matter-expert feedback with OpenAI.`],[`MediaConvert`,`Automated video processing and editor assignment with AWS MediaConvert.`],[`QR access`,`Gave factory workers QR-code access to training.`],[`Offline streaming`,`Delivered adaptive streaming with offline viewing for industrial networks.`],[`5-role RBAC`,`Built multi-tenant access control for five user types, with audit trails.`]]},{id:`nac`,slot:2,landmark:`capitol`,start:`2025-04`,end:`2025-12`,years:`2025`,company:`National Accreditation Commission`,place:`Remote`,title:`Interim CTO / Lead Engineering Architect`,blurb:`A state-level AI Hub for workforce Pell grant distribution and non-credit institution accreditation.`,obstacles:[[`Graph RAG`,`Built hybrid Graph RAG verification that cut manual review time by 75%.`],[`90% accuracy`,`Reached 90% compliance-detection accuracy.`],[`15-min checks`,`Designed event-driven serverless processing for 15-minute asynchronous compliance checks.`],[`Governor’s office`,`Worked directly with the Chief Data Officer for the Office of Governor Sarah Huckabee Sanders.`],[`OpenAI HQ`,`Presented at OpenAI × GitLab Foundation Demo Day at OpenAI headquarters in San Francisco.`,null,`award`],[`Mentored 4`,`Mentored 4 George Washington University master’s students in AI and RAG.`]]},{id:`addi`,slot:-2,landmark:`billboards`,start:`2025-10`,end:`2026-06`,years:`2025–2026`,company:`Addi`,place:`Kansas City metro, remote`,title:`Senior Software Engineer (contract)`,blurb:`Tools for small businesses to manage and publish AI-generated ad campaigns.`,obstacles:[[`Campaign UI`,`Built the Addi interface for managing AI-generated ad campaigns.`],[`Meta Ads`,`Built the Meta Ads publishing integration.`],[`TikTok Ads`,`Built the TikTok Ads publishing integration.`],[`Google + YouTube`,`Built the Google Ads and YouTube Ads integrations.`],[`Spotify Ads`,`Built the Spotify Ads integration.`]]},{id:`oneimaging`,slot:0,landmark:`imaging`,start:`2026-01`,end:`now`,years:`2026–now`,company:`OneImaging`,place:`Remote (HQ in Miami, FL)`,title:`Staff Software Engineer`,blurb:`Patient imaging scheduling and care coordination.`,obstacles:[[`OI Investigator`,`Shipped OI Investigator, a HIPAA-scoped AI agent (Claude on Bedrock, ECS Fargate) that root-causes support tickets.`],[`200+ tickets`,`OI Investigator triaged 200+ tickets in its first two months.`],[`800+ hours`,`Saved an estimated 800+ engineering hours of manual investigation.`],[`RIS integration`,`Led the AdvancedMD RIS integration for real-time, multi-facility availability.`],[`Jumpstart`,`Delivered Jumpstart, fast-path booking against pending orders.`],[`Playwright gate`,`Built the first Playwright end-to-end suite as a blocking pre-merge gate.`],[`Flyway migrations`,`Architected Flyway migrations with unsafe-DDL linting and drift detection.`],[`Support rotation`,`Set up the engineering support rotation and triage process.`],[`Flags + analytics`,`Added feature flags and improved product analytics in Amplitude.`],[`Fax callbacks`,`Reworked the fax integration to use callbacks for faster sending and receiving.`],[`Agentic harness`,`Building an agentic development harness with automated end-to-end checks.`]]}],Ud=[[`HackMidwest 3rd`,`HackMidwest 2023: CareCue, a healthcare AI chatbot for caregivers. 3rd place.`,`2023-10`],[`FLL mentor`,`Mentor, First Lego League (2023), ICJC Mavericks.`,`2023-03`],[`HackMidwest 1st`,`HackMidwest 2024: Taini, a voice AI accountability coach. 1st place, Best in AI from AWS.`,`2024-10`]],Wd={id:`chicago`,landmark:`chicago`,company:`Chicago, IL`,place:`Home base`,years:`Now`,title:`Where the road is today`,blurb:`Every road merges here. Thanks for driving.`},Gd=[[`AI / ML`,`Amazon Bedrock, Claude, OpenAI, AI agents, LangChain, Graph RAG, Neo4j, Pinecone, guardrails, evals`],[`Healthcare`,`HL7, X12 EDI (837/270/271/835), AdvancedMD RIS, HIPAA`],[`Cloud`,`AWS, ECS Fargate, Lambda, EventBridge, Serverless, SST, Terraform`],[`Backend`,`Node.js, PHP, Python, FastAPI, Express, Spring Boot, Java`],[`Frontend`,`React, Vue 3, TypeScript, Electron, PWAs`],[`Data`,`Aurora PostgreSQL, MySQL, MongoDB, DynamoDB, Redis, Flyway`],[`Delivery`,`GitHub Actions, GitLab CI, Docker, Kubernetes, Playwright, Testcontainers`],[`Security`,`Auth0, OAuth 2.0, SAML, Azure AD, Cognito, MFA, WAF`]];function Kd(e,t=!1){let n=e[0].index!==null,r=new Set(Object.keys(e[0].attributes)),i=new Set(Object.keys(e[0].morphAttributes)),a={},o={},s=e[0].morphTargetsRelative,c=new Or,l=0;for(let u=0;u<e.length;++u){let d=e[u],f=0;if(n!==(d.index!==null))return console.error(`THREE.BufferGeometryUtils: .mergeGeometries() failed with geometry at index `+u+`. All geometries must have compatible attributes; make sure index attribute exists among all geometries, or in none of them.`),null;for(let e in d.attributes){if(!r.has(e))return console.error(`THREE.BufferGeometryUtils: .mergeGeometries() failed with geometry at index `+u+`. All geometries must have compatible attributes; make sure "`+e+`" attribute exists among all geometries, or in none of them.`),null;a[e]===void 0&&(a[e]=[]),a[e].push(d.attributes[e]),f++}if(f!==r.size)return console.error(`THREE.BufferGeometryUtils: .mergeGeometries() failed with geometry at index `+u+`. Make sure all geometries have the same number of attributes.`),null;if(s!==d.morphTargetsRelative)return console.error(`THREE.BufferGeometryUtils: .mergeGeometries() failed with geometry at index `+u+`. .morphTargetsRelative must be consistent throughout all geometries.`),null;for(let e in d.morphAttributes){if(!i.has(e))return console.error(`THREE.BufferGeometryUtils: .mergeGeometries() failed with geometry at index `+u+`.  .morphAttributes must be consistent throughout all geometries.`),null;o[e]===void 0&&(o[e]=[]),o[e].push(d.morphAttributes[e])}if(t){let e;if(n)e=d.index.count;else if(d.attributes.position!==void 0)e=d.attributes.position.count;else return console.error(`THREE.BufferGeometryUtils: .mergeGeometries() failed with geometry at index `+u+`. The geometry must have either an index or a position attribute`),null;c.addGroup(l,e,u),l+=e}}if(n){let t=0,n=[];for(let r=0;r<e.length;++r){let i=e[r].index;for(let e=0;e<i.count;++e)n.push(i.getX(e)+t);t+=e[r].attributes.position.count}c.setIndex(n)}for(let e in a){let t=qd(a[e]);if(!t)return console.error(`THREE.BufferGeometryUtils: .mergeGeometries() failed while trying to merge the `+e+` attribute.`),null;c.setAttribute(e,t)}for(let e in o){let t=o[e][0].length;if(t!==0){c.morphAttributes=c.morphAttributes||{},c.morphAttributes[e]=[];for(let n=0;n<t;++n){let t=[];for(let r=0;r<o[e].length;++r)t.push(o[e][r][n]);let r=qd(t);if(!r)return console.error(`THREE.BufferGeometryUtils: .mergeGeometries() failed while trying to merge the `+e+` morphAttribute.`),null;c.morphAttributes[e].push(r)}}}return c}function qd(e){let t,n,r,i=-1,a=0;for(let o=0;o<e.length;++o){let s=e[o];if(t===void 0&&(t=s.array.constructor),t!==s.array.constructor)return console.error(`THREE.BufferGeometryUtils: .mergeAttributes() failed. BufferAttribute.array must be of consistent array types across matching attributes.`),null;if(n===void 0&&(n=s.itemSize),n!==s.itemSize)return console.error(`THREE.BufferGeometryUtils: .mergeAttributes() failed. BufferAttribute.itemSize must be consistent across matching attributes.`),null;if(r===void 0&&(r=s.normalized),r!==s.normalized)return console.error(`THREE.BufferGeometryUtils: .mergeAttributes() failed. BufferAttribute.normalized must be consistent across matching attributes.`),null;if(i===-1&&(i=s.gpuType),i!==s.gpuType)return console.error(`THREE.BufferGeometryUtils: .mergeAttributes() failed. BufferAttribute.gpuType must be consistent across matching attributes.`),null;a+=s.count*n}let o=new t(a),s=new mr(o,n,r),c=0;for(let t=0;t<e.length;++t){let r=e[t];if(r.isInterleavedBufferAttribute){let e=c/n;for(let t=0,i=r.count;t<i;t++)for(let i=0;i<n;i++){let n=r.getComponent(t,i);s.setComponent(t+e,i,n)}}else o.set(r.array,c);c+=r.count*n}return i!==void 0&&(s.gpuType=i),s}var Jd=`"Overpass", system-ui, sans-serif`;function Yd(e,t){let n=document.createElement(`canvas`);return n.width=e,n.height=t,[n,n.getContext(`2d`)]}function Xd(e,t=[1,1]){let r=new ea(e);return r.colorSpace=Re,r.wrapS=r.wrapT=n,r.repeat.set(...t),r.anisotropy=8,r}var Zd=7,Qd=()=>(Zd=Zd*16807%2147483647)/2147483647,$d=new Map;function ef({wall:e=`#6f7b86`,glass:t=`#2b3a48`,lit:n=`#ffe6a8`,frame:r=null,cols:i=4,rows:a=4,glassy:o=!1}={}){let s=JSON.stringify(arguments[0]??{});if($d.has(s))return $d.get(s);let[c,l]=Yd(256,256);l.fillStyle=e,l.fillRect(0,0,256,256);let u=256/i,d=256/a;for(let e=0;e<a;e++)for(let a=0;a<i;a++){let i=o?2:u*.18,s=o?2:d*.22,c=l.createLinearGradient(0,e*d,0,(e+1)*d),f=Qd()<.03,p=Qd()*30;c.addColorStop(0,f?n:sf(t,55+p)),c.addColorStop(.55,f?sf(n,-20):sf(t,18+p*.5)),c.addColorStop(1,f?sf(n,-40):t),l.fillStyle=c,l.fillRect(a*u+i,e*d+s,u-i*2,d-s*2),r&&(l.strokeStyle=r,l.lineWidth=2,l.strokeRect(a*u+i,e*d+s,u-i*2,d-s*2))}let f=Xd(c);return $d.set(s,f),f}function tf(e=`#d9ccb1`){let[t,n]=Yd(256,256);n.fillStyle=e,n.fillRect(0,0,256,256);for(let t=0;t<8;t++){let r=t%2?24:0;for(let i=-r;i<256;i+=48)n.fillStyle=sf(e,(Qd()-.5)*22),n.fillRect(i+1,t*32+1,46,30)}for(let e=0;e<1400;e++)n.fillStyle=`rgba(60,50,30,${Qd()*.08})`,n.fillRect(Qd()*256,Qd()*256,2,2);return Xd(t)}function nf(e=`#8e4a36`){let[t,n]=Yd(256,256);n.fillStyle=`#cbbfae`,n.fillRect(0,0,256,256);for(let t=0;t<16;t++){let r=t%2?16:0;for(let i=-r;i<256;i+=32)n.fillStyle=sf(e,(Qd()-.5)*30),n.fillRect(i+1,t*16+1,30,14)}return Xd(t)}function rf(e,{w:t=512,h:n=160,bg:r=`#0b6b3a`,fg:i=`#f7f9f4`,border:a=!0,weight:o=800}={}){let[s,c]=Yd(t,n);c.fillStyle=r,c.beginPath(),c.roundRect(0,0,t,n,n*.14),c.fill(),a&&(c.strokeStyle=i,c.lineWidth=n*.045,c.beginPath(),c.roundRect(n*.07,n*.07,t-n*.14,n-n*.14,n*.1),c.stroke()),c.fillStyle=i,c.textAlign=`center`,c.textBaseline=`middle`;let l=e.length;return e.forEach((e,r)=>{let i=r===0?n*(l>1?.36:.5):n*.22;for(c.font=`${r===0?o:600} ${i}px ${Jd}`;c.measureText(e).width>t-n*.4&&i>8;)i-=2,c.font=`${r===0?o:600} ${i}px ${Jd}`;let a=l===1?n/2:n*(.38+(r-(l-1)/2)*.34)+(r===0?0:n*.06);c.fillText(e,t/2,a+n*.03)}),Xd(s)}function af(e,t,n){let[r,i]=Yd(1024,400),a=i.createLinearGradient(0,0,1024,400);return a.addColorStop(0,n),a.addColorStop(1,sf(n,-40)),i.fillStyle=a,i.fillRect(0,0,1024,400),i.fillStyle=`#ffffff`,i.textAlign=`left`,i.textBaseline=`alphabetic`,i.font=`800 120px ${Jd}`,i.fillText(e,60,200),i.font=`600 52px ${Jd}`,i.fillText(t,64,290),Xd(r)}function of(e,t=`#101826`){let[n,r]=Yd(1024,576);return r.fillStyle=t,r.fillRect(0,0,1024,576),r.fillStyle=`#f7f9f4`,r.textAlign=`center`,r.font=`800 96px ${Jd}`,r.fillText(e[0],512,270),r.font=`600 44px ${Jd}`,r.fillText(e[1]??``,512,350),Xd(n)}function sf(e,t){let n=parseInt(e.slice(1),16),r=e=>Math.max(0,Math.min(255,e+t));return`rgb(${r(n>>16)},${r(n>>8&255)},${r(n&255)})`}function cf(e=`70`,t=256){let[n,i]=Yd(t,t),a=e=>{let n=t,r=e;i.beginPath(),i.moveTo(n*.08+r,n*.1+r),i.quadraticCurveTo(n*.5,n*.02+r,n*.92-r,n*.1+r),i.bezierCurveTo(n*.98-r,n*.55,n*.8,n*.82,n*.5,n*.96-r),i.bezierCurveTo(n*.2,n*.82,n*.02+r,n*.55,n*.08+r,n*.1+r),i.closePath()};i.fillStyle=`#ffffff`,a(0),i.fill(),i.save(),a(t*.035),i.clip(),i.fillStyle=`#1f4ea0`,i.fillRect(0,0,t,t),i.fillStyle=`#c8202f`,i.fillRect(0,0,t,t*.3),i.fillStyle=`#ffffff`,i.fillRect(0,t*.3,t,t*.025),i.restore(),i.fillStyle=`#ffffff`,i.textAlign=`center`,i.textBaseline=`middle`,i.font=`800 ${t*.1}px ${Jd}`,i.fillText(`INTERSTATE`,t/2,t*.19),i.font=`800 ${t*.44}px ${Jd}`,i.fillText(e,t/2,t*.6);let o=Xd(n);return o.wrapS=o.wrapT=r,o}var lf={main:`#dbe7ff`,ksu:`#a78bfa`,collegian:`#ffb454`,softek:`#7ee787`,cerner:`#4fc3f7`,rxss:`#2ee6b6`,fluxpilot:`#38bdf8`,annovox:`#ff6bcb`,nac:`#c792ea`,addi:`#ff7b72`,oneimaging:`#5aa9ff`,chicago:`#ffd166`},uf=`#ffd166`;function df(e){let t=2166136261;for(let n=0;n<e.length;n++)t^=e.charCodeAt(n),t=Math.imul(t,16777619);return(t>>>0).toString(16).padStart(8,`0`).slice(0,7)}var ff=36,pf=150;function mf(e,t){let n=Math.sin(e*127.1+t*311.7)*43758.5453;return n-Math.floor(n)}function hf(e,t){let n=Math.floor(e),r=Math.floor(t),i=e-n,a=t-r,o=i*i*(3-2*i),s=a*a*(3-2*a),c=mf(n,r),l=mf(n+1,r),u=mf(n,r+1),d=mf(n+1,r+1);return c+(l-c)*o+(u-c)*s+(c-l-u+d)*o*s}function gf(e,t){return hf(e,t)*.55+hf(e*2.03,t*2.03)*.28+hf(e*4.1,t*4.1)*.12+hf(e*8.3,t*8.3)*.05}var _f=(e,t=0)=>mf(e*1.37+t*9.1,t*3.7+e*.13),vf=(e,t,n)=>Dt.smoothstep(e,t,n),yf=(e,t)=>{let[n,r]=e.split(`-`).map(Number),[i,a]=t.split(`-`).map(Number);return(n-i)*12+(r-a)};function bf({sections:e,semesters:t,finish:n,community:r,NOW:i,TIMELINE_START:a}){let o=e=>80+yf(e,a)*ff,s=o(i),c=s+180,l=c+320,u=e.map((e,t)=>{let n=e.slot?34+14*Math.abs(e.slot):0,r=o(e.start),i=e.end===`now`?c-30:o(e.end),a=n*2+e.obstacles.length*15+24;return i-r<a&&(i=r+a),{...e,index:t,taper:n,s0:r,s1:i}}),d=(e,t)=>e.slot?e.slot*8*vf(t,e.s0,e.s0+e.taper)*(1-vf(t,e.s1-e.taper,e.s1)):0,f=e=>u.filter(t=>t.slot&&e>t.s0&&e<t.s1),p=e=>[0,...f(e).map(t=>d(t,e))];u.forEach(e=>{let n=e.slot?e.s0+e.taper+12:e.s0+30,r=e.slot?e.s1-e.taper-6:e.s1-16,i=[];e.kind===`campus`&&t.forEach((e,t)=>i.push({type:`gate`,s:Dt.clamp(o(e.date),n,r),sem:e,index:t,gap:26}));let a=e.obstacles.filter(e=>!e[2]),s=0;e.obstacles.forEach(([e,t,c,l],u)=>{let d=c?Dt.clamp(o(c),n,r):n+(s+++.5)/a.length*(r-n);i.push({type:l===`award`?`release`:`commit`,s:d,label:e,text:t,index:u,gap:15})}),i.sort((e,t)=>e.s-t.s);for(let e=1;e<i.length;e++){let t=Math.max(i[e-1].gap,15);i[e].s<i[e-1].s+t&&(i[e].s=i[e-1].s+t)}e.items=i,e.landmarkS=e.slot?e.s0+e.taper+10:e.s0+12;let c=u.filter(t=>t.slot&&t!==e&&t.s0<e.landmarkS+90&&t.s1>e.landmarkS-60),l=e.slot?Math.sign(e.slot):c.filter(e=>e.slot>0).length<=c.filter(e=>e.slot<0).length?1:-1,d=Math.max(Math.abs(e.slot),...c.filter(e=>Math.sign(e.slot)===l).map(e=>Math.abs(e.slot)));e.side=l,e.landmarkOffset=l*(d*8+4+44)}),(r??[]).forEach(([e,t,n],r)=>{let i=o(n),a=u.filter(e=>!e.slot&&i>=e.s0).at(-1);a.items.push({type:`release`,community:!0,s:i,label:e,text:t,index:100+r,gap:18}),a.items.sort((e,t)=>e.s-t.s);for(let e=1;e<a.items.length;e++)a.items[e].s<a.items[e-1].s+16&&(a.items[e].s=a.items[e-1].s+16)});let m={...n,landmarkS:c+110,side:1,landmarkOffset:58,s0:c,items:[]},h=[];for(let e=+a.slice(0,4)+1;e<=+i.slice(0,4);e++)h.push({year:e,s:o(`${e}-01`)});return{roles:u,finish:m,offset:d,activeAt:f,lanesAt:p,sOf:o,nowS:s,finishS:c,length:l,years:h}}function xf(e){let t=[],n=0,r=0;for(let i=0;i<=e+20;i+=20){t.push(new W(n,0,r));let e=Math.PI+.6*Math.sin(i/380)+.38*Math.sin(i/140+1.3)+.12*Math.sin(i/55+.4);n+=Math.sin(e)*20,r+=Math.cos(e)*20}let i=new Ca(t,!1,`centripetal`),a=i.getLength(),o=Math.ceil(a/1.5),s=[];for(let e=0;e<=o;e++){let t=e/o,n=i.getPointAt(t),r=i.getTangentAt(t);s.push({i:e,u:t,s:t*a,p:n,t:r,n:new W(-r.z,0,r.x),heading:Math.atan2(r.x,r.z)})}let c=e=>s[Dt.clamp(Math.round(e/a*o),0,o)],l=(e,t=0)=>{let n=Dt.clamp(e/a,0,1),r=i.getPointAt(n),o=i.getTangentAt(n);return{p:r.add(new W(-o.z,0,o.x).multiplyScalar(t)),t:o}},u=0;function d(e,t=!1){let n=u,r=1/0,i=t?0:Math.max(0,u-160),a=t?o:Math.min(o,u+160);for(let t=i;t<=a;t++){let i=s[t].p,a=(i.x-e.x)**2+(i.z-e.z)**2;a<r&&(r=a,n=t)}return!t&&r>8100?d(e,!0):(u=n,{sample:s[n],dist:Math.sqrt(r)})}return{curve:i,samples:s,total:a,at:c,point:l,nearest:d,reset:e=>{u=e}}}function Sf(){let e=document.createElement(`canvas`);e.width=e.height=512;let t=e.getContext(`2d`);t.fillStyle=`#000`,t.fillRect(0,0,512,512),t.strokeStyle=`rgba(80,120,200,0.55)`,t.lineWidth=2,t.strokeRect(0,0,512,512),t.strokeStyle=`rgba(80,120,200,0.18)`,t.lineWidth=1;for(let e=64;e<512;e+=64)t.beginPath(),t.moveTo(e,0),t.lineTo(e,512),t.moveTo(0,e),t.lineTo(512,e),t.stroke();let r=new ea(e);return r.wrapS=r.wrapT=n,r.anisotropy=8,r}function Cf(e,t,n=10,r=3,i=!1){let a=document.createElement(`canvas`);a.width=Math.round(n*110),a.height=Math.round(r*110);let o=a.getContext(`2d`);o.fillStyle=`rgba(6,10,20,0.78)`,o.beginPath(),o.roundRect(0,0,a.width,a.height,26),o.fill(),o.strokeStyle=t,o.lineWidth=7,o.shadowColor=t,o.shadowBlur=18,o.beginPath(),o.roundRect(8,8,a.width-16,a.height-16,20),o.stroke(),o.fillStyle=`#ffffff`,o.textAlign=`center`,o.textBaseline=`middle`;let s=e.length;e.forEach((e,n)=>{let r=n===0,c=a.height*(s===1?.42:r?.3:.2),l=i||r&&e.startsWith(`$`)?`"JetBrains Mono", ui-monospace, monospace`:`"Overpass", system-ui, sans-serif`;for(o.font=`${r?800:600} ${c}px ${l}`;o.measureText(e).width>a.width*.88&&c>8;)c-=2,o.font=`${r?800:600} ${c}px ${l}`;o.fillStyle=r?t:`#e8eefc`,o.shadowBlur=r?14:0;let u=s===1?a.height/2:a.height*(.36+(n-(s-1)/2)*.34)+(r?0:a.height*.06);o.fillText(e,a.width/2,u)});let c=new ea(a);return c.colorSpace=Re,c.anisotropy=8,new J(new Fo(n,r),new ai({map:c,transparent:!0,toneMapped:!1,side:2,depthWrite:!1}))}function wf(e,t,n){let{samples:r}=t,i=r.filter((e,t)=>t%8==0),a=(e,t)=>{let n=1/0,r=i[0];for(let a of i){let i=(a.p.x-e)**2+(a.p.z-t)**2;i<n&&(n=i,r=a)}return{d:Math.sqrt(n),s:r}},o=e=>n.roles.filter(t=>!t.slot&&e>=t.s0-1).at(-1)??n.roles[0],s=e=>lf[e.id]??lf.main,c=new Xn().setFromPoints(r.map(e=>e.p)),l=c.max.x-c.min.x+1600,u=c.max.z-c.min.z+1600,d=(c.max.x+c.min.x)/2,f=(c.max.z+c.min.z)/2,p=new Fo(l,u,Math.round(l/14),Math.round(u/14));p.rotateX(-Math.PI/2),p.translate(d,0,f);let m=p.attributes.position,h=(e,t,n)=>gf(e*.004,t*.004)*140*vf(n,pf,410)**1.5;for(let e=0;e<m.count;e++){let t=m.getX(e),n=m.getZ(e);m.setY(e,h(t,n,a(t,n).d)-.1)}p.computeVertexNormals();let g=Sf();g.repeat.set(l/40,u/40);let _=new J(p,new Yo({color:`#070a12`,roughness:.85,metalness:.2,emissive:`#3a5a9a`,emissiveMap:g,emissiveIntensity:.55}));_.receiveShadow=!0,e.add(_);let v=e=>{let t=n.lanesAt(e);return[Math.min(...t)-4,Math.max(...t)+4]},y=(e,t,n,i,a,o)=>{let s=[],c=[],l=[],u=new K;r.filter(n=>n.s>=e&&n.s<=t).forEach((e,t)=>{let r=n(e.s),d=i(e.s);if(s.push(e.p.x+e.n.x*d,a,e.p.z+e.n.z*d,e.p.x+e.n.x*r,a,e.p.z+e.n.z*r),o&&(u.set(o(e.s)),c.push(u.r,u.g,u.b,u.r,u.g,u.b)),t>0){let e=(t-1)*2;l.push(e,e+2,e+1,e+1,e+2,e+3)}});let d=new Or;return d.setAttribute(`position`,new q(s,3)),o&&d.setAttribute(`color`,new q(c,3)),d.setIndex(l),d.computeVertexNormals(),d},b=e=>e>n.finishS-20?lf.chicago:s(o(e)),x=new J(y(0,t.total,e=>v(e)[0],e=>v(e)[1],.05),new Yo({color:`#0b0e15`,roughness:.55,metalness:.5}));x.receiveShadow=!0,e.add(x);let S=new ai({vertexColors:!0,transparent:!0,opacity:.07,depthWrite:!1,toneMapped:!1});e.add(new J(y(0,t.total,()=>-3.7,()=>3.7,.06,b),S)),n.roles.filter(e=>e.slot).forEach(t=>{let r=e=>n.offset(t,e);e.add(new J(y(t.s0,t.s1,e=>r(e)-4+.3,e=>r(e)+4-.3,.065,()=>s(t)),S))});let C=new ai({vertexColors:!0,toneMapped:!1});for(let n of[0,1])e.add(new J(y(0,t.total,e=>v(e)[n]+(n?-.35:.13),e=>v(e)[n]+(n?-.13:.35),.08,b),C));{let t=new Y(.16,.02,2.4),i=new Zt,a=new Ot,o=new W(0,1,0),c=new W(1,1,1);n.roles.filter(e=>e.slot).forEach(l=>{let u=r.filter(e=>e.s>l.s0+6&&e.s<l.s1-6&&e.s%8<1.5),d=new Oi(t,new ai({color:s(l),toneMapped:!1,transparent:!0,opacity:.8}),u.length);u.forEach((e,t)=>{let r=n.offset(l,e.s)-Math.sign(l.slot)*8/2;a.setFromAxisAngle(o,e.heading),i.compose(new W(e.p.x+e.n.x*r,.09,e.p.z+e.n.z*r),a,c),d.setMatrixAt(t,i)}),e.add(d)})}{let t=[],n=[],i=[],a=[],o=[],s=[],c=new K;for(let e of[0,1]){let l=null;for(let u of r){if(u.i%2)continue;let r=v(u.s)[e]+(e?.7:-.7),d=u.p.clone().addScaledVector(u.n,r);if(l){let e=t.length/3;for(let[e,n]of[[l,.45],[d,.45],[l,.95],[d,.95]])t.push(e.x,n,e.z);c.set(b(u.s));for(let e=0;e<4;e++)n.push(c.r,c.g,c.b);i.push(e,e+1,e+2,e+1,e+3,e+2),o.push(l.x,.97,l.z,d.x,.97,d.z),s.push(c.r,c.g,c.b,c.r,c.g,c.b)}u.i%8==0&&a.push(d),l=d}}let l=new Or;l.setAttribute(`position`,new q(t,3)),l.setAttribute(`color`,new q(n,3)),l.setIndex(i),l.computeVertexNormals(),e.add(new J(l,new Yo({vertexColors:!0,metalness:.8,roughness:.35,side:2,emissive:`#ffffff`,emissiveIntensity:.08})));let u=new Or;u.setAttribute(`position`,new q(o,3)),u.setAttribute(`color`,new q(s,3)),e.add(new Gi(u,new Ni({vertexColors:!0,toneMapped:!1})));let d=new Oi(new Y(.14,1,.14).translate(0,.5,0),new Yo({color:`#39414d`,metalness:.7,roughness:.4}),a.length),f=new Zt;a.forEach((e,t)=>{f.makeTranslation(e.x,0,e.z),d.setMatrixAt(t,f)}),e.add(d)}n.roles.forEach(r=>{let i=s(r),a=r.slot?r.s0+r.taper+4:r.s0+4,o=t.at(a),c=Cf([r.slot?`$ git checkout -b ${r.id}`:`$ git switch main  # ${r.id}`,`${r.company}, ${r.years}`],i,7.6,2.3);if(c.position.copy(o.p).addScaledVector(o.n,n.offset(r,a)),c.position.y=7.2,c.rotation.y=o.heading+Math.PI,e.add(c),r.slot&&r.end!==`now`){let a=t.at(r.s1-r.taper*.5),o=Cf([`$ git merge ${r.id}`,`${r.company} ended ${r.end.slice(0,4)}`],i,7.2,2);o.position.copy(a.p).addScaledVector(a.n,n.offset(r,r.s1-r.taper*.5)),o.position.y=6.5,o.rotation.y=a.heading+Math.PI,e.add(o)}}),n.years.forEach(({year:n,s:r})=>{let i=t.at(r),a=Cf([String(n)],`#dbe7ff`,7,2.6);a.material.opacity=.7,a.position.copy(i.p),a.position.y=13,a.rotation.y=i.heading+Math.PI,e.add(a)});{let r=t.at(n.finishS),i=Cf([`$ git log --graph`,`All branches merge in Chicago`],lf.chicago,12,3);i.position.copy(r.p),i.position.y=8,i.rotation.y=r.heading+Math.PI,e.add(i,Tf(i,lf.chicago))}let w=cf(`70`);for(let r=160;r<n.finishS;r+=420){let i=n.activeAt(r).some(e=>e.slot<0)?1:-1,a=t.at(r),o=v(r)[+(i>0)],s=new J(new Fo(2.2,2.2),new ai({map:w,transparent:!0,toneMapped:!1,side:2}));s.position.copy(a.p).addScaledVector(a.n,o+i*3),s.position.y=3.2,s.rotation.y=a.heading+Math.PI;let c=Cf([`I-70 EAST`],`#dbe7ff`,2.6,.7);c.position.copy(s.position),c.position.y=4.8,c.rotation.copy(s.rotation);let l=new J(new oa(.07,.07,3.2,6),new Yo({color:`#39414d`,metalness:.7,roughness:.4}));l.position.copy(s.position),l.position.y=1.6,e.add(s,c,l)}let T=[...n.roles,n.finish].map(e=>{let n=t.at(e.landmarkS);return{p:n.p.clone().addScaledVector(n.n,e.landmarkOffset),r:70}}),E=(e,t,r)=>n.lanesAt(e).every(e=>Math.abs(e-t)>4+r),D=n.roles.find(e=>e.id===`cerner`);return[[D.s0+40,D.s1,70,lf.cerner],[n.finishS-120,n.finishS+300,150,lf.chicago]].forEach(([n,r,i,a],o)=>{let s=[],c=[];for(let e=n;e<r;e+=14)for(let n of[-1,1]){let r=Math.floor(e*3+n*7+o*131);if(_f(r,1)<.3)continue;let a=t.at(e),l=n*(40+_f(r,2)*140);if(!E(e,l,30))continue;let u=a.p.clone().addScaledVector(a.n,l);if(T.some(e=>e.p.distanceTo(u)<e.r))continue;let d=8+_f(r,3)*12,f=8+_f(r,4)*12,p=14+_f(r,5)**2*i*(Math.abs(l)<70?.6:1),m=new Y(d,p,f);m.rotateY(a.heading),m.translate(u.x,p/2,u.z),c.push(m);let h=new pa(new Y(d,p,f));h.rotateY(a.heading),h.translate(u.x,p/2,u.z),s.push(h);for(let e=6;e<p-2;e+=5){let t=new pa(new Y(d+.05,.01,f+.05));t.rotateY(a.heading),t.translate(u.x,e,u.z),s.push(t)}}if(!c.length)return;let l=new J(Kd(c),new Yo({color:`#0a0f1c`,roughness:.3,metalness:.6,transparent:!0,opacity:.88})),u=new Gi(Kd(s),new Ni({color:a,transparent:!0,opacity:.55,toneMapped:!1}));e.add(l,u)}),{heightAt:h}}function Tf(e,t){let n=new En,r=new Yo({color:`#2a313c`,metalness:.7,roughness:.4}),i=e.geometry.parameters.width;for(let t of[-1,1]){let a=new J(new oa(.12,.14,e.position.y+1,8),r);a.position.set(t*(i/2+.3),(e.position.y+1)/2,0),n.add(a)}return n.position.copy(e.position),n.position.y=0,n.rotation.copy(e.rotation),n}var Z=e=>new Yo({roughness:.8,...e}),Q=(e,t,n,r,i=0,a=0,o=0)=>{let s=new J(new Y(e,t,n),r);return s.position.set(i,a+t/2,o),s},Ef=(e,t,n,r,i=0,a=0,o=0,s=16)=>{let c=new J(new oa(e,t,n,s),r);return c.position.set(i,a+n/2,o),c},Df=(e,t,n)=>{let r=e.clone();return r.needsUpdate=!0,r.repeat.set(t,n),r},Of=(e,t,n,r)=>new ai({map:rf(e,{w:Math.round(t*90),h:Math.round(n*90),...r}),toneMapped:!1});function kf(e,t,n,r={}){let i=Z({color:`#5b6168`});return new J(new Y(t,n,.25),[i,i,i,i,Of(e,t,n,r),i])}function Af(e,t,n,r){let i=new ko(new Wa([new U(-e/2,0),new U(e/2,0),new U(0,t)]),{depth:n,bevelEnabled:!1});return i.translate(0,0,-n/2),new J(i,r)}function jf(e,t,n,r,i){let a=new En;for(let i=0;i<e;i++){let o=Ef(.55,.65,n,r,-t/2+t/(e-1)*i,1.2,0,12);a.add(o)}a.add(Q(t+2.4,1.2,4,i,0,0,-1)),a.add(Q(t+2.4,1.1,4,i,0,n+1.2,-1));let o=Af(t+2.6,3.2,4.2,i);return o.position.set(0,n+2.3,-1),a.add(o),a}function Mf(e,t){let n=new En;switch(e){case`campus`:{let e=Z({map:Df(tf(),4,2),roughness:.95}),t=Z({map:Df(ef({wall:`#d6c9ad`,glass:`#39424c`,cols:3,rows:2,frame:`#b8aa8c`}),6,2)}),r=Z({color:`#4b4f57`,roughness:.7}),i=e=>{n.add(Q(16,11,12,t,e,0,0));let i=Af(16.4,5,12.4,r);i.position.set(e,11,0),n.add(i)};i(-13),i(13),n.add(Q(10,14,13,e,0,0,.5)),n.add(Q(7,16,7,e,0,14,1));for(let[t,i]of[[-3.5,-2.5],[3.5,-2.5],[-3.5,4.5],[3.5,4.5]]){n.add(Ef(.9,.9,20,e,t,12,i,10));let a=new J(new sa(1.2,3.5,10),r);a.position.set(t,33.7,i),n.add(a)}let a=new J(new sa(4.6,10,4),r);a.position.set(0,35,1),a.rotation.y=Math.PI/4,n.add(a);let o=new J(new aa(1.6,24),Z({color:`#f3efe4`}));o.position.set(0,25,4.55),n.add(o);let s=Af(4,2.4,1,e);s.position.set(0,4.2,7.2),n.add(s,Q(3,4.2,.4,Z({color:`#3b2a1c`}),0,0,7.1));let c=new J(new Fo(50,26),Z({color:`#5d9142`}));c.rotation.x=-Math.PI/2,c.position.set(0,.03,19),n.add(c);let l=new J(new Fo(4,26),Z({color:`#cdc6b6`}));l.rotation.x=-Math.PI/2,l.position.set(0,.05,19),n.add(l);let u=[];for(let e=0;e<=10;e++)u.push(new U(16+e*1.6,e*1.3));u.push(new U(33,13.3),new U(33,0));let d=new J(new No(u,48),Z({color:`#512888`,side:2,roughness:.7}));d.scale.set(1.25,1,.85),d.position.set(-36,0,-46),n.add(d);let f=new J(new Fo(34,22),Z({color:`#3f8a3a`}));f.rotation.x=-Math.PI/2,f.position.set(-36,.06,-46),n.add(f);for(let e=-3;e<=3;e++){let t=new J(new Fo(.25,22),Z({color:`#f5f5f0`}));t.rotation.x=-Math.PI/2,t.position.set(-36+e*4.5,.07,-46),n.add(t)}let p=kf([`K-State`],10,3,{bg:`#512888`});p.position.set(-36,18,-70),n.add(p);break}case`press`:{let e=Z({map:Df(nf(),4,3)});n.add(Q(26,10,14,e)),n.add(Q(26.6,1,14.6,Z({color:`#d8d0c0`}),0,10));let t=Z({map:Df(ef({wall:`#8e4a36`,glass:`#2d3640`,cols:6,rows:2,frame:`#e9e0cf`}),1,1)}),r=new J(new Fo(25.6,9),t);r.position.set(0,5,7.02),n.add(r);let i=kf([`Collegian Media Group`],10,2.2);i.position.set(0,12.8,7.2),n.add(i);let a=Z({color:`#e8e4da`});for(let e=0;e<6;e++)n.add(Q(1.4,.6,1,a,9+e%3*1.5,Math.floor(e/3)*.6,9));break}case`office`:{let e=Z({map:Df(ef({wall:`#2f3d49`,glass:`#6c8fac`,cols:6,rows:3,glassy:!0}),3,1),metalness:.6,roughness:.2});n.add(Q(28,13,16,e)),n.add(Q(29,.8,17,Z({color:`#d7dbde`}),0,13)),n.add(Q(8,4,4,Z({color:`#cfd4d8`}),0,0,9));let t=kf([`Softek`],7,1.8,{bg:`#1f3b57`});t.position.set(0,14.8,8.2),n.add(t);let r=new J(new Fo(30,12),Z({color:`#4a4c50`}));r.rotation.x=-Math.PI/2,r.position.set(0,.04,17),n.add(r);break}case`cerner`:{let e=Z({map:Df(ef({wall:`#2a4a66`,glass:`#7fa9c9`,cols:6,rows:10,glassy:!0}),2,3),metalness:.7,roughness:.15});n.add(Q(16,58,16,e,-12,0,-4)),n.add(Q(14,44,14,e,12,0,-2)),n.add(Q(10,3,5,Z({color:`#c9d2d9`,metalness:.5}),0,22,-3)),n.add(Q(40,6,20,Z({map:Df(ef({wall:`#cfd6db`,glass:`#4f6f8a`,cols:8,rows:1}),2,1)}),0,0,6));let t=kf([`Cerner`],9,2.2,{bg:`#0f5f95`});t.position.set(0,7.5,16.2),n.add(t);let r=Z({map:Df(tf(`#d9d2c0`),1,6)});n.add(Q(24,3,12,r,34,0,-40),Ef(3.2,3.8,50,r,34,3,-40,12));let i=Ef(1.8,2.6,5,Z({color:`#f2c14e`,emissive:`#e07b2a`,emissiveIntensity:.6}),34,53,-40,12);n.add(i);break}case`rxss`:{let e=Z({map:Df(ef({wall:`#8a949c`,glass:`#28394a`,cols:5,rows:8,frame:`#b9c1c7`}),2,3),metalness:.2});n.add(Q(22,34,16,e,-6,0,-6)),n.add(Q(22.6,1.2,16.6,Z({color:`#c9cfd4`}),-6,34,-6));let r=kf([`Rx Savings Solutions`],12,2,{bg:`#006f86`});r.position.set(-6,30,2.2),n.add(r);let i=kf([`McKesson`],8,1.8,{bg:`#1b4f9c`});i.position.set(-6,26.5,2.2),n.add(i),n.add(Q(6,2,6,Z({color:`#d8d4cc`}),14,0,8));let a=new En,o=new J(new ia(2.1,3.4,8,20),Z({color:`#f7f9f4`,roughness:.3})),s=new ia(2.14,3.4,8,20,1),c=s.attributes.position,l=[];for(let e=0;e<s.index.count;e+=3){let t=[0,1,2].map(t=>c.getY(s.index.getX(e+t)));Math.min(...t)>=-.01&&l.push(s.index.getX(e),s.index.getX(e+1),s.index.getX(e+2))}s.setIndex(l);let u=new J(s,Z({color:`#12a08f`,roughness:.3}));a.add(o,u),a.position.set(14,7.5,8),a.rotation.z=.9,n.add(a),t.push(e=>{a.rotation.y=e*.5});break}case`bess`:{let e=new J(new Fo(56,38),Z({color:`#a9a69c`}));e.rotation.x=-Math.PI/2,e.position.set(0,.04,0),n.add(e);let r=Z({map:Df(ef({wall:`#eef0ee`,glass:`#c8ccc9`,cols:8,rows:1,frame:`#d7dad7`}),1,1)});for(let e=0;e<3;e++)for(let t=0;t<5;t++)n.add(Q(8,3,2.6,r,-20+t*10,0,-12+e*7));let i=Z({color:`#7d8a80`,metalness:.4});n.add(Q(6,4,5,i,22,0,10));for(let e=0;e<3;e++)n.add(Ef(.3,.3,3,Z({color:`#b5693a`}),20.5+e*1.5,4,10,8));let a=Z({color:`#9aa0a3`,metalness:.6,transparent:!0,opacity:.55});n.add(Q(58,2.4,.1,a,0,0,19),Q(58,2.4,.1,a,0,0,-19));let o=kf([`Fluxpilot`,`Battery energy storage`],11,2.8,{bg:`#0d4f6c`});o.position.set(-16,3,21),n.add(o);let s=Z({color:`#f1f3f4`,roughness:.5});[[-18,-42],[4,-48],[26,-40]].forEach(([e,r],i)=>{n.add(Ef(.9,1.6,42,s,e,0,r,12));let a=new En;a.position.set(e,42,r+1.6),a.add(new J(new Io(1.1,12,8),s));for(let e=0;e<3;e++){let t=new J(new Y(1.1,20,.3).translate(0,10,0),s);t.rotation.z=e/3*Math.PI*2,a.add(t)}n.add(Q(2,1.8,4,s,e,41.1,r-.4),a),t.push(e=>{a.rotation.z=e*.8+i})});let c=Z({color:`#1f3550`,metalness:.6,roughness:.25});for(let e=0;e<4;e++){let t=Q(40,.2,3,c,0,1.4,26+e*4.2);t.rotation.x=-.35,n.add(t)}break}case`factory`:{let e=Z({map:Df(nf(`#7f4431`),6,2)});n.add(Q(36,9,20,e));let r=Z({color:`#6c6f73`,metalness:.4});for(let e=0;e<6;e++){let t=Af(6,3.5,20,r);t.position.set(-15+e*6,9,0),t.scale.x=1,n.add(t),n.add(Q(.2,3.3,19.6,Z({color:`#9fc2da`,metalness:.3,roughness:.2}),-12.1+e*6,9,0))}let i=Z({color:`#7a6c62`});n.add(Ef(1.2,1.6,22,i,13,0,-7,12),Ef(1,1.4,18,i,17,0,-4,12));let a=[];for(let e=0;e<6;e++){let e=new J(new Mo(1.4,1),new Yo({color:`#e7e7e7`,transparent:!0,depthWrite:!1}));n.add(e),a.push(e)}t.push(e=>a.forEach((t,n)=>{let r=(e*.25+n/a.length)%1;t.position.set(13+r*3,22+r*12,-7),t.scale.setScalar(.7+r*2.2),t.material.opacity=.85*(1-r)}));for(let e=0;e<3;e++)n.add(Q(4,5,.3,Z({color:`#5b6066`,metalness:.5}),-12+e*6,0,10.1));let o=new J(new Fo(10,5.6),new ai({map:of([`Factory-floor training`,`QR-code access · offline viewing`]),toneMapped:!1}));o.position.set(8,6.5,10.2),n.add(o);let s=kf([`Annovox AI`],9,2,{bg:`#28324a`});s.position.set(-8,10.5,10.3),n.add(s);let c=new En;c.add(Q(3,3.4,9,Z({color:`#e9ebec`}),0,.8,0),Q(3,2.8,2.6,Z({color:`#c8322b`}),0,.8,6)),c.position.set(-6,0,16),n.add(c);break}case`capitol`:{let e=Z({map:Df(tf(`#e8e3d6`),6,2),roughness:.9}),t=Z({color:`#ece7da`,roughness:.85});n.add(Q(64,3,22,t,0,0,0)),n.add(Q(60,12,18,e,0,3,0)),n.add(Q(61,1.4,19,t,0,15,0));let r=jf(8,20,9,t,t);r.position.set(0,3,10.5),n.add(r);for(let e of[-22,22]){let r=jf(6,11,9,t,t);r.position.set(e,3,10.5),n.add(r)}n.add(Ef(9,9.5,5,t,0,16.4,0,32));for(let e=0;e<20;e++){let r=e/20*Math.PI*2;n.add(Ef(.45,.5,8,t,Math.cos(r)*8.2,21.4,Math.sin(r)*8.2,10))}n.add(Ef(7.9,7.9,8,e,0,21.4,0,32)),n.add(Ef(8.8,8.8,1.2,t,0,29.4,0,32));let i=new J(new Io(8,32,16,0,Math.PI*2,0,Math.PI/2),t);i.position.set(0,30.6,0),i.scale.y=1.15,n.add(i),n.add(Ef(1.6,1.8,4,t,0,39.6,0,12));let a=new J(new Io(1.8,12,8,0,Math.PI*2,0,Math.PI/2),Z({color:`#c9a445`,metalness:.7,roughness:.3}));a.position.set(0,43.6,0),n.add(a);for(let e=0;e<6;e++)n.add(Q(24-e*2,.5,1.4,t,0,e*.5,13+e*1.3-6));let o=new En;o.add(Q(16,1.2,8,Z({color:`#1d1f24`})));let s=new J(new Fo(14,7.8),new ai({map:of([`Demo Day`,`OpenAI × GitLab Foundation, San Francisco`],`#0e0f12`),toneMapped:!1}));s.position.set(0,6,-3.6),o.add(s),o.add(Q(15,.5,.5,Z({color:`#2a2c31`}),0,10,-3.6)),o.add(Ef(.3,.4,1.3,Z({color:`#3a3d44`}),2,1.2,1,8)),o.position.set(44,0,18),o.rotation.y=-.5,n.add(o);break}case`billboards`:{let e=[[`Meta Ads`,`Published with Addi`,`#1b64d8`],[`TikTok Ads`,`Published with Addi`,`#15121a`],[`Google Ads`,`Published with Addi`,`#1a8f47`],[`YouTube Ads`,`Published with Addi`,`#c5221f`],[`Spotify Ads`,`Published with Addi`,`#1a9e52`]],t=Z({color:`#7b8187`,metalness:.6});e.forEach(([e,r,i],a)=>{let o=new En;o.add(Ef(.5,.6,12,t,0,0,0,10)),o.add(Q(15,6.4,.6,Z({color:`#2d3136`}),0,12,0));let s=new J(new Fo(14.4,5.8),new ai({map:af(e,r,i),toneMapped:!1}));s.position.set(0,15.2,.31),o.add(s),o.add(Q(15,.3,1.2,t,0,11.8,.6)),o.position.set(-44+a*22,0,a%2*-16),o.rotation.y=(a-2)*-.12,n.add(o)});break}case`imaging`:{let e=Z({color:`#f1f3f2`,roughness:.6}),r=Z({color:`#9cc4d6`,metalness:.2,roughness:.05,transparent:!0,opacity:.35});n.add(Q(30,9,18,Z({map:Df(ef({wall:`#e9ecea`,glass:`#7fa6b8`,cols:5,rows:2}),2,1)}),-8,0,-2)),n.add(Q(16,8,12,r,15,0,1)),n.add(Q(16.6,.8,12.6,e,15,8,1)),n.add(Q(16,.3,12,Z({color:`#d7dcdb`}),15,.05,1));let i=new J(new Lo(2.6,1.1,16,40),e);i.position.set(15,3.6,1),n.add(i);let a=new J(new Lo(1.55,.08,8,40),Z({color:`#2fa3d6`,emissive:`#2fa3d6`,emissiveIntensity:.6}));a.position.set(15,3.6,1.2),n.add(a);let o=Q(1.4,.4,5,Z({color:`#2fa3d6`}),15,2.6,3);n.add(o,Q(1.2,2.6,1.6,Z({color:`#c9ced2`}),15,0,4)),t.push(e=>{o.position.z=2.6+Math.sin(e*.7)*1.6});let s=kf([`OneImaging`],10,2.2,{bg:`#1c6fb5`});s.position.set(-8,9.8,7.2),n.add(s);break}case`chicago`:{let e=Z({map:Df(ef({wall:`#1c1f24`,glass:`#3b4652`,cols:4,rows:16,glassy:!0}),1,4),metalness:.6,roughness:.3});[[108,70,70],[108,108,90],[90,90,50]].forEach((t,r)=>t.forEach((t,i)=>n.add(Q(7,t,7,e,-40+i*7,0,-70+r*7)))),n.add(Ef(.3,.4,20,Z({color:`#d0d4d8`}),-37,108,-70,6),Ef(.3,.4,16,Z({color:`#d0d4d8`}),-30,108,-63,6));let r=new J(new oa(6.5,11,96,4,1),e);r.rotation.y=Math.PI/4,r.position.set(12,48,-90),n.add(r),n.add(Ef(.3,.4,18,Z({color:`#d0d4d8`}),10,96,-90,6),Ef(.3,.4,18,Z({color:`#d0d4d8`}),14,96,-90,6));let i=Z({color:`#d8d6d0`});for(let e of[34,44]){n.add(Ef(3.8,3.8,52,Z({color:`#8f8c86`}),e,0,-46,20));for(let t=16;t<52;t+=2.2){let r=new J(new Lo(4.4,.55,6,18),i);r.rotation.x=Math.PI/2,r.position.set(e,t,-46),n.add(r)}}let a=new J(new Fo(40,30),Z({color:`#c9c5bc`}));a.rotation.x=-Math.PI/2,a.position.set(-4,.04,6),n.add(a);let o=new J(new Io(4,48,24),Z({color:`#ffffff`,metalness:1,roughness:.04}));o.scale.set(2,1,1.3),o.position.set(-4,3.4,6),n.add(o);let s=new J(new Fo(600,400),Z({color:`#2d6f8f`,metalness:.3,roughness:.15}));s.rotation.x=-Math.PI/2,s.position.set(0,.2,-330),n.add(s);let c=Z({color:`#e0b43c`,metalness:.9,roughness:.25});[-14,14].forEach((e,r)=>{n.add(Q(3,2,3,Z({color:`#2f3237`}),e,0,14)),n.add(Ef(.4,.8,1.6,c,e,2,14,12));let i=Ef(1.6,.6,2.4,c,e,3.6,14,18);n.add(i),t.push(e=>{i.rotation.y=e*(r?-1:1)})});break}}return n.traverse(e=>{e.isMesh&&!e.material.transparent&&(e.castShadow=!0,e.receiveShadow=!0)}),n}function Nf(e,t,{faceOpacity:n=.18,edgeOpacity:r=.95,threshold:i=25}={}){let a=new K(t),o=new ai({color:a.clone().multiplyScalar(.18),transparent:!0,opacity:n,depthWrite:!1,side:2}),s=new Ni({color:a,transparent:!0,opacity:r,toneMapped:!1}),c=[];return e.traverse(e=>{e.isMesh&&c.push(e)}),c.forEach(e=>{if(e.material?.map&&e.material.isMeshBasicMaterial)return;let t=new Gi(new pa(e.geometry,i),s);t.position.copy(e.position),t.quaternion.copy(e.quaternion),t.scale.copy(e.scale),e.parent.add(t),e.material=o,e.castShadow=e.receiveShadow=!1}),e}function Pf(){let e=new En,t=new Xo({color:`#b9c0c7`,metalness:.85,roughness:.28,clearcoat:1,clearcoatRoughness:.12}),n=new Xo({color:`#00c2b0`,metalness:.3,roughness:.35,clearcoat:1,emissive:`#00c2b0`,emissiveIntensity:.9}),r=new Yo({color:`#15171a`,roughness:.45,metalness:.3}),i=new Yo({color:`#0d0e10`,roughness:.7}),a=new Yo({color:`#141414`,roughness:.9}),o=new Yo({color:`#2b2e33`,metalness:.8,roughness:.3}),s=(t,n,r=0,i=0,a=0,o=e)=>{let s=new J(t,n);return s.position.set(r,i,a),o.add(s),s},c=(e,t,n,r=.04)=>{let i=new ko(new Wa(e.map(([e,t])=>new U(e,t))),{depth:t,bevelEnabled:!0,bevelSize:r,bevelThickness:r,bevelSegments:3,curveSegments:12});return i.rotateY(-Math.PI/2),i.translate(t/2,0,0),new J(i,n)};s(new Y(1.5,.05,3.2),r,0,.12,-.35);let l=c([[-1.3,.16],[1.1,.16],[1.5,.3],[1.1,.52],[.35,.58],[-.25,.72],[-1.3,.66]],.72,t);e.add(l);let u=new J(new oa(.07,.3,1.5,16,1),t);u.rotation.x=Math.PI/2+.08,u.scale.set(1,1,.55),u.position.set(0,.3,2.1),e.add(u),s(new Io(.075,12,8),n,0,.24,2.85);for(let r of[-1,1]){let a=c([[-1.5,.18],[.55,.18],[.62,.36],[.5,.56],[-.2,.55],[-1.5,.3]],.42,t,.06);a.position.x=r*.56,e.add(a);let o=s(new Y(.4,.2,.04),i,r*.56,.44,.6);o.rotation.x=-.2,s(new Y(.04,.12,1.6),n,r*.79,.3,-.5)}let d=c([[-2.05,.3],[-.25,.72],[.05,.92],[-.3,.98],[-2.05,.46]],.46,t);e.add(d);let f=c([[-2.1,.46],[-.35,.98],[-.6,1.02],[-2.1,.86]],.02,n,.005);e.add(f),s(new Y(.22,.2,.08),i,0,.98,.03);let p=document.createElement(`canvas`);p.width=512,p.height=128;let m=p.getContext(`2d`);m.fillStyle=`#00c2b0`,m.font=`800 88px ${Jd}`,m.textAlign=`center`,m.textBaseline=`middle`,m.fillText(`HAHMED.DEV`,256,68);let h=new ea(p);h.colorSpace=Re;for(let t of[-1,1]){let n=new J(new Fo(.9,.22),new ai({map:h,transparent:!0,toneMapped:!1}));n.position.set(t*.243,.62,-1),n.rotation.y=t*Math.PI/2,e.add(n)}s(new Io(.16,20,14),new Xo({color:`#f2f4f5`,clearcoat:1,roughness:.2}),0,.78,.15).scale.set(1,.95,1.1),s(new Io(.162,20,10,-.9,1.8,1.2,.5),new Xo({color:`#10161c`,metalness:.6,roughness:.05}),0,.78,.15).scale.set(1,.95,1.1);let g=new J(new Lo(.34,.035,10,32,Math.PI),r);g.rotation.x=-Math.PI/2,g.position.set(0,.9,.12),e.add(g);let _=s(new oa(.03,.035,.4,8),r,0,.8,.58);_.rotation.x=-.9;for(let e of[-1,1]){let n=s(new Y(.16,.07,.05),t,e*.52,.72,.45);s(new oa(.01,.01,.16,6),r,e*.46,.66,.45).rotation.z=Math.PI/2,n.castShadow=!0}let v=new En;v.position.set(0,.12,2.75),e.add(v),[0,.07,.13].forEach((e,t)=>{let i=s(new Y(1.95-t*.2,.025,.28-t*.05),t===2?n:r,0,e,-t*.13,v);i.rotation.x=-.12-t*.12});for(let e of[-1,1])s(new Y(.03,.22,.5),r,e*.98,.08,-.1,v);let y=new En;y.position.set(0,.92,-2.2),e.add(y),s(new Y(1.1,.03,.34),r,0,0,0,y).rotation.x=.15,s(new Y(1.1,.025,.2),n,0,.13,-.08,y).rotation.x=.45;for(let e of[-1,1])s(new Y(.03,.5,.58),t,e*.56,-.08,-.02,y);s(new Y(.06,.45,.08),r,0,-.25,.05,y),s(new Y(.9,.025,.16),r,0,.4,-2.15);let b=s(new Y(1,.18,.4),r,0,.18,-2.05);b.rotation.x=-.35;let x=new Yo({color:`#5a0a08`,emissive:`#ff2418`,emissiveIntensity:.6});s(new Y(.1,.08,.03),x,0,.3,-2.3);let S=[],C=[],w=new Yo({color:`#e0322b`,roughness:.6}),T=(e,t)=>{let n=new En,r=new J(new oa(e,e,t,32).rotateZ(Math.PI/2),a),i=new J(new oa(e*.6,e*.6,t+.01,20).rotateZ(Math.PI/2),o),s=new J(new Lo(e*.78,.012,6,32),w);s.rotation.y=Math.PI/2;let c=s.clone();c.position.x=t/2+.002;let l=s.clone();l.position.x=-t/2-.002;for(let r=0;r<6;r++){let i=new J(new Y(t+.02,.03,e*1.1),o);i.rotation.x=r/6*Math.PI,n.add(i)}return n.add(r,i,c,l),n};return[[.36,.36,.86,1.9,!0],[.38,.45,.86,-1.55,!1]].forEach(([t,n,i,a,o])=>{for(let s of[-1,1]){let c=new En;c.position.set(s*i,t,a);let l=T(t,n);c.add(l),e.add(c),S.push(l),o&&C.push(c);for(let[o,c]of[[.1,.15],[-.08,-.15]]){let l=new W(s*.35,.35+o,a+c),u=new W(s*(i-n/2),t+o*.6,a),d=new J(new oa(.018,.018,l.distanceTo(u),6),r);d.position.copy(l).add(u).multiplyScalar(.5),d.quaternion.setFromUnitVectors(new W(0,1,0),u.clone().sub(l).normalize()),e.add(d)}}}),e.traverse(e=>{e.isMesh&&!e.material.transparent&&(e.castShadow=!0)}),{group:e,spin:e=>S.forEach((t,n)=>{t.rotation.x+=e/(n<2?.36:.38)}),steer:e=>C.forEach(t=>{t.rotation.y+=(e*.45-t.rotation.y)*.25}),brake:e=>{x.emissiveIntensity=e?3:.6}}}var Ff=`"JetBrains Mono", ui-monospace, monospace`;function If(e,t,n,r=1){let i=document.createElement(`canvas`),a=i.getContext(`2d`),o=`700 40px ${Ff}`;a.font=o;let s=Math.ceil(a.measureText(`${e}  ${t}`).width)+48;i.width=s,i.height=72,a.fillStyle=`rgba(6,10,20,0.8)`,a.beginPath(),a.roundRect(0,0,s,72,14),a.fill(),a.strokeStyle=n,a.lineWidth=3,a.beginPath(),a.roundRect(2,2,s-4,68,12),a.stroke(),a.font=o,a.textBaseline=`middle`,a.fillStyle=n,a.fillText(e,24,38),a.fillStyle=`#eef3ff`,a.fillText(t,24+a.measureText(`${e}  `).width,38);let c=new ea(i);c.colorSpace=Re;let l=new Qr(new Rr({map:c,depthWrite:!1,toneMapped:!1}));return l.scale.set(s/72*.75*r,.75*r,1),l}var Lf=new Lo(2.1,.12,12,56),Rf=new Mo(.2,1),zf=new Y(.55,.55,.55),Bf=new pa(zf),Vf=new Po(1.1,0);function Hf(e){let t=new En,n=new ai({color:e,toneMapped:!1,transparent:!0}),r=new J(Lf,n);r.position.y=2.6;let i=new J(Rf,new ai({color:e,transparent:!0}));return i.position.y=2.6,t.add(r,i),t.userData={ring:r,core:i,mats:[n,i.material]},t}function Uf(e){let t=new En,n=new J(zf,new ai({color:new K(e).multiplyScalar(.35),transparent:!0,opacity:.8})),r=new Gi(Bf,new Ni({color:e,toneMapped:!1,transparent:!0}));return n.add(r),n.position.y=1.2,t.add(n),t.userData={spin:n,mats:[n.material,r.material]},t}function Wf(){let e=new En,t=new J(Vf,new Yo({color:uf,emissive:uf,emissiveIntensity:.9,metalness:.9,roughness:.2,transparent:!0}));t.position.y=2.4;let n=new J(new Lo(1.7,.05,8,48),new ai({color:uf,toneMapped:!1,transparent:!0}));return n.rotation.x=Math.PI/2,n.position.y=2.4,e.add(t,n),e.userData={spin:t,halo:n,mats:[t.material,n.material]},e}var Gf;function Kf(){if(Gf)return Gf;let e=document.createElement(`canvas`);e.width=e.height=64;let t=e.getContext(`2d`),n=t.createRadialGradient(32,32,0,32,32,32);return n.addColorStop(0,`rgba(255,255,255,1)`),n.addColorStop(.4,`rgba(255,255,255,0.6)`),n.addColorStop(1,`rgba(255,255,255,0)`),t.fillStyle=n,t.fillRect(0,0,64,64),Gf=new ea(e)}function qf(e){let t=[];for(let n=0;n<8;n++){let n=new Or;n.setAttribute(`position`,new q(new Float32Array(270),3));let r=new Zi(n,new Ki({size:.16,map:Kf(),alphaTest:.01,transparent:!0,depthWrite:!1,toneMapped:!1,blending:2}));r.visible=!1,r.frustumCulled=!1,e.add(r),t.push({pts:r,vel:new Float32Array(270),t:99})}let n=0;return{fire(e,r){let i=t[n++%t.length],a=i.pts.geometry.attributes.position.array;for(let t=0;t<90;t++){a[t*3]=e.x,a[t*3+1]=e.y,a[t*3+2]=e.z;let n=Math.random()*Math.PI*2,r=Math.acos(2*Math.random()-1),o=2+Math.random()*5;i.vel[t*3]=Math.sin(r)*Math.cos(n)*o,i.vel[t*3+1]=Math.abs(Math.cos(r))*o,i.vel[t*3+2]=Math.sin(r)*Math.sin(n)*o}i.pts.material.color.set(r),i.pts.material.opacity=1,i.pts.visible=!0,i.t=0,i.pts.geometry.attributes.position.needsUpdate=!0},update(e){for(let n of t){if(n.t>1.2){n.pts.visible=!1;continue}n.t+=e;let t=n.pts.geometry.attributes.position.array;for(let r=0;r<t.length;r++)t[r]+=n.vel[r]*e,r%3==1&&(n.vel[r]-=9*e);n.pts.geometry.attributes.position.needsUpdate=!0,n.pts.material.opacity=Math.max(0,1-n.t/1.2)}}}}function Jf(e,t,n){let r=[],i=qf(e);n.roles.forEach(i=>{let a=lf[i.id]??lf.main;i.items.forEach((o,s)=>{let c=n.offset(i,o.s),l=t.at(o.s);if(o.type===`gate`){let n=o.sem,s=Cf([`$ git tag ${`v${n.term.split(` `)[1]}-${n.term.split(` `)[0].toLowerCase()}`}`,n.honors?`${n.term} · semester honors`:n.term],a,7.4,2);s.position.copy(l.p).addScaledVector(l.n,c),s.position.y=6.4,s.rotation.y=l.heading+Math.PI,e.add(s);let u=n.courses.length,d=o.s+9,f=t.at(d);n.courses.forEach(([t,o],s)=>{let l=Uf(a),p=c+(s-(u-1)/2)*Math.min(1.15,6.4/Math.max(1,u-1));l.position.copy(f.p).addScaledVector(f.n,p);let m=If(``,t,a,.75);m.position.y=2.3,l.add(m),e.add(l),r.push({kind:`course`,mesh:l,s:d,lateral:p,laneOff:c,radius:.8,role:i.index,title:t,text:`${t}: ${o}`,term:n.term,color:a,hash:df(t+n.term)})})}else{let t=o.type===`release`,n=c,s=t?Wf():Hf(a);s.position.copy(l.p).addScaledVector(l.n,n),s.rotation.y=l.heading;let u=df(o.text),d=If(u,o.label,t?uf:a);d.position.y=t?4.6:5.6,s.add(d),e.add(s),r.push({kind:t?o.community?`community`:`release`:`commit`,mesh:s,s:o.s,lateral:n,radius:t?1.4:2.4,role:i.index,title:o.label,text:o.text,color:t?uf:a,hash:u})}})});let a=[];function o(e,t){e.hit=!0,e.t=0,e.mesh.children.filter(e=>e.isSprite).forEach(e=>e.removeFromParent()),e.start=e.mesh.position.clone(),i.fire(e.mesh.position.clone().add(new W(0,e.kind===`course`?1.2:2.5,0)),e.color),a.push(e)}function s(e,t,n,s){for(let e of r){if(e.hit||Math.abs(e.s-t.s)>8)continue;let n=Math.hypot(e.mesh.position.x-t.x,e.mesh.position.z-t.z)<e.radius+1,r=t.s>e.s+.5&&t.prevS<=e.s+.5&&Math.abs(t.lateral-(e.laneOff??e.lateral))<4;(n||r)&&(o(e,t),s(e,n))}for(let e of r){if(e.hit||Math.abs(e.s-t.s)>260)continue;let r=e.mesh.userData;r.spin&&(r.spin.rotation.y=n*1.4+e.s,r.spin.rotation.x=n*.6),r.core&&r.core.scale.setScalar(1+Math.sin(n*4+e.s)*.2),r.halo&&(r.halo.rotation.z=n)}for(let n=a.length-1;n>=0;n--){let r=a[n];r.t+=e;let i=Math.min(1,r.t/(r.kind===`course`?.5:.32)),o=r.mesh;r.kind===`course`?(o.position.lerpVectors(r.start,new W(t.x,0,t.z),i),o.scale.setScalar(1-i*.9)):(o.scale.setScalar(1+i*.35),o.position.y=r.start.y+i*1.2),o.userData.mats.forEach(e=>{e.opacity=1-i}),i>=1&&(o.removeFromParent(),a.splice(n,1))}i.update(e)}return{list:r,update:s}}var Yf=(e,t,n,r)=>(e.position.set(t,n,r),e),Xf=e=>new ai({color:e,toneMapped:!1});function Zf(){let e=new En,t=new J(new Fo(260,16),new Yo({color:`#0c0f16`,roughness:.5,metalness:.5}));t.rotation.x=-Math.PI/2,t.position.set(0,.06,-40),e.add(t);let n=new Oi(new Io(.25,8,6),Xf(`#ffd9a0`),88),r=new Zt;for(let e=0;e<44;e++){let t=-128+e*6;r.makeTranslation(t,.3,-48.4),n.setMatrixAt(e*2,r),r.makeTranslation(t,.3,-31.6),n.setMatrixAt(e*2+1,r)}e.add(n);let i=new Oi(new Y(4,.03,.4),Xf(`#dbe7ff`),22);for(let e=0;e<22;e++)r.makeTranslation(-120+e*11.5,.08,-40),i.setMatrixAt(e,r);e.add(i);let a=new En;a.add(Yf(new J(new Y(46,8,14),new Yo),0,4,4));let o=new J(new oa(9,9,48,24,1,!0,0,Math.PI),new Yo);o.rotation.z=Math.PI/2,o.rotation.y=Math.PI/2,o.scale.set(1,1,.35),o.position.set(0,8,4),a.add(o);let s=new J(new oa(1.6,2.2,30,10),new Yo);s.position.set(38,15,2);let c=new J(new oa(4,3,4,10),new Yo);c.position.set(38,32,2),a.add(s,c),Nf(a,`#5aa9ff`),e.add(a);let l=new J(new Io(.6,10,8),Xf(`#2ee6b6`));l.position.set(38,35,2),e.add(l);let u=Cf([`Fly to Miami`,`OneImaging HQ`],`#5aa9ff`,10,2.6);return u.position.set(0,13,12),e.add(u),{group:e,runwayStart:new W(-115,0,-40),runwayEnd:new W(125,0,-40),apron:new W(-20,0,14),beacon:l}}function Qf(){let e=new En,t=new Xo({color:`#e9eef3`,metalness:.3,roughness:.35,clearcoat:1}),n=new Yo({color:`#00c2b0`,metalness:.3,roughness:.4}),r=new Yo({color:`#1c222b`,metalness:.6,roughness:.4}),i=new J(new oa(1.7,1.7,26,20),t);i.rotation.z=Math.PI/2,e.add(i);let a=new J(new Io(1.7,20,14,0,Math.PI*2,0,Math.PI/2),t);a.rotation.z=-Math.PI/2,a.scale.set(1,2.1,1),a.position.x=13,e.add(a);let o=new J(new sa(1.7,7,20),t);o.rotation.z=Math.PI/2,o.position.set(-16.5,.5,0),e.add(o);let s=new J(new Y(2.2,.6,2.4),r);s.position.set(14.2,.9,0),s.rotation.z=-.35,e.add(s);let c=new J(new Y(20,.35,3.45),Xf(`#ffe7b0`));c.position.set(-1,.55,0),e.add(c);let l=new J(new Y(26,.3,3.46),n);l.position.set(-1,-.4,0),e.add(l);let u=new Wa([new U(0,0),new U(-5,15),new U(-7.5,15),new U(-7,0)]);for(let n of[-1,1]){let i=new J(new ko(u,{depth:.35,bevelEnabled:!1}),t);i.rotation.x=n>0?Math.PI/2:-Math.PI/2,i.position.set(3,-.6,0),e.add(i);let a=new J(new oa(.9,.75,4,16),r);a.rotation.z=Math.PI/2,a.position.set(1.8,-1.6,n*5.5),e.add(a);let o=new J(new Y(3,.2,5),t);o.position.set(-16,.8,n*2.8),o.rotation.y=n*-.35,e.add(o);let s=new J(new Io(.28,8,6),Xf(n>0?`#ff3b3b`:`#35ff7a`));s.position.set(-3.8,-.4,n*15),e.add(s)}let d=new J(new ko(new Wa([new U(0,0),new U(-4.5,6.5),new U(-6.5,6.5),new U(-5,0)]),{depth:.3,bevelEnabled:!1}),n);d.position.set(-13,1.2,-.15),e.add(d);let f=new J(new Io(.35,8,6),Xf(`#ffffff`));return f.position.set(-19.5,7.2,0),e.add(f),e.userData.strobe=f,e.traverse(e=>{e.isMesh&&(e.castShadow=!0)}),e.scale.setScalar(.8),e}function $f(){let e=new En,t=new J(new Fo(4200,4200,1,1),new Yo({color:`#06121f`,metalness:.9,roughness:.12}));t.rotation.x=-Math.PI/2,t.position.y=-1.5,e.add(t);let n=new J(new Y(700,3,320),new Yo({color:`#0a0d14`,roughness:.9}));n.position.set(0,-.5,-40),e.add(n);let r=new J(new Y(700,2.8,26),new Yo({color:`#3a3326`,roughness:1}));r.position.set(0,-.4,133),e.add(r);let i=[`#ff6bcb`,`#2ee6b6`,`#c792ea`,`#ffb454`,`#5aa9ff`];for(let t=0;t<16;t++){let n=10+t%4*4,r=22+t%3*6,a=new En;a.add(Yf(new J(new Y(r,n,16),new Yo),0,n/2,0)),a.add(Yf(new J(new Y(6,n+6,6),new Yo),-r/2+5,(n+6)/2,6)),Nf(a,i[t%i.length],{faceOpacity:.35});let o=new J(new Y(r+.2,.5,16.2),Xf(i[(t+2)%i.length]));o.position.y=n*.7,a.add(o),a.position.set(-330+t*44,0,100),e.add(a)}for(let t=0;t<22;t++){let n=60+t*37%11*12,r=14+t%3*4,i=new En;i.add(Yf(new J(new Y(r,n,r),new Yo),0,n/2,0)),Nf(i,t%2?`#5aa9ff`:`#2ee6b6`,{faceOpacity:.3,edgeOpacity:.7});for(let e=8;e<n;e+=6){let t=new J(new Y(r+.1,.25,r+.1),Xf(`#9fc9ff`));t.material.transparent=!0,t.material.opacity=.35,t.position.y=e,i.add(t)}i.position.set(-260+t%11*50,0,-60-Math.floor(t/11)*60),e.add(i)}let a=new En;a.add(Yf(new J(new Y(24,150,24),new Yo),0,75,0)),a.add(Yf(new J(new oa(10,12,12,16),new Yo),0,156,0)),Nf(a,`#5aa9ff`,{faceOpacity:.4});let o=Cf([`OneImaging`,`HQ · Miami, FL`],`#5aa9ff`,30,9);o.position.set(0,128,12.2),a.add(o);let s=o.clone();s.position.set(0,128,-12.2),s.rotation.y=Math.PI,a.add(s),a.position.set(40,0,10),e.add(a);let c=new Yo({color:`#2a2218`,roughness:1}),l=new Yo({color:`#12301f`,roughness:.9,side:2,emissive:`#0b3b2a`,emissiveIntensity:.4});for(let t=0;t<40;t++){let n=new En,r=(t%5-2)*.8,i=new za(new W(0,0,0),new W(r,7,0),new W(r*2.2,13,0));n.add(new J(new Ro(i,10,.35,6),c));for(let e=0;e<7;e++){let t=new J(new Fo(6,1.2),l);t.position.set(r*2.2,13,0),t.rotation.set(.5,e/7*Math.PI*2,-.4),t.geometry.translate(3,0,0),n.add(t)}n.position.set(-340+t*17.5,0,130+t%3*3),e.add(n)}return{group:e,hq:new W(40,110,10)}}function ep({scene:e,airportGroup:t,airport:n,miamiGroup:r,miami:i,onCaption:a,onDone:o}){let s=Qf();s.visible=!1,e.add(s);let c=(e,t)=>t.localToWorld(e.clone()),l=!1,u=0,d,f,p=new W,m=new W;function h(){t.updateMatrixWorld(),r.updateMatrixWorld();let e=c(n.runwayStart,t),o=c(n.runwayEnd,t),p=c(i.hq,r),m=o.clone().sub(e).normalize(),h=e.clone().lerp(o,.55),g=o.clone().addScaledVector(m,200);g.y=120;let _=g.clone().lerp(p,.5);_.y=260;let v=p.clone().sub(g).setY(0).normalize(),y=p.clone().addScaledVector(v,-320);y.y=150;let b=new W(-v.z,0,v.x),x=[0,1,2,3,4].map(e=>{let t=e/4*Math.PI*1.6;return p.clone().addScaledVector(v,-Math.cos(t)*150).addScaledVector(b,Math.sin(t)*150).setY(135)});d={roll:[e.clone().setY(1.6),h.clone().setY(1.6)],air:new Ca([h.clone().setY(1.6),o.clone().setY(24),g,_,y,...x],!1,`centripetal`,.5),hq:p},f={roll:3.2,air:13},u=0,l=!0,s.visible=!0,a(`Jumping out of the car. OneImaging is headquartered in Miami, and I work remotely and fly in when needed.`)}function g(e,t,n){if(!l)return!1;if(u+=e,s.userData.strobe.visible=Math.sin(n*12)>.6,u<f.roll){let e=(u/f.roll)**2;s.position.lerpVectors(d.roll[0],d.roll[1],e);let t=d.roll[1].clone().sub(d.roll[0]).normalize();s.rotation.set(0,Math.atan2(-t.z,t.x),0),p.copy(s.position).addScaledVector(t,-34).add(new W(0,9,0)).addScaledVector(new W(-t.z,0,t.x),14),m.copy(s.position).addScaledVector(t,10)}else{let t=Math.min(1,(u-f.roll)/f.air),n=t<.5?2*t*t:1-(-2*t+2)**2/2,r=d.air.getPointAt(n),i=d.air.getPointAt(Math.min(1,n+.01)),o=i.clone().sub(r).normalize();s.position.copy(r),s.rotation.set(0,0,0),s.lookAt(r.clone().add(o)),s.rotateY(-Math.PI/2);let c=new W(-o.z,0,o.x).dot(d.air.getPointAt(Math.min(1,n+.03)).sub(i).normalize());if(s.rotateX(-c*1.2),t>.62?(g.hqShown||(g.hqShown=!0,a(`OneImaging HQ, Miami. Staff Software Engineer, remote since January 2026.`)),p.lerp(d.hq.clone().add(new W(260,170,260)),Math.min(1,e*1.5)),m.lerp(d.hq,Math.min(1,e*2))):(p.copy(r).addScaledVector(o,-40).add(new W(0,12,0)),m.copy(r).addScaledVector(o,20)),t>=1)return _(),!1}return t.position.copy(p),t.lookAt(m),!0}function _(){l=!1,s.visible=!1,g.hqShown=!1,o()}return{start:h,update:g,skip:()=>l&&_(),get active(){return l}}}function tp(){let e,t,n,r,i=!1;function a(){e=new AudioContext,t=e.createOscillator(),t.type=`sawtooth`;let i=e.createOscillator();i.type=`square`,r=e.createBiquadFilter(),r.type=`lowpass`,r.frequency.value=400,n=e.createGain(),n.gain.value=0;let a=e.createGain();a.gain.value=.4,t.connect(r),i.connect(a).connect(r),r.connect(n).connect(e.destination),t.start(),i.start(),t.sub=i}return{get on(){return i},pause(){e&&e.suspend()},resume(){e&&i&&e.resume()},toggle(){return e||a(),i=!i,i?e.resume():n.gain.setTargetAtTime(0,e.currentTime,.05),i},engine(a){if(!i)return;let o=38+Math.abs(a)*3.2;t.frequency.setTargetAtTime(o,e.currentTime,.05),t.sub.frequency.setTargetAtTime(o/2,e.currentTime,.05),r.frequency.setTargetAtTime(300+Math.abs(a)*25,e.currentTime,.05),n.gain.setTargetAtTime(.05+Math.min(Math.abs(a),40)*.0025,e.currentTime,.1)},hit(t=1){if(!i)return;let n=e.createBuffer(1,e.sampleRate*.25,e.sampleRate),r=n.getChannelData(0);for(let e=0;e<r.length;e++)r[e]=(Math.random()*2-1)*(1-e/r.length)**3;let a=e.createBufferSource();a.buffer=n;let o=e.createBiquadFilter();o.type=`lowpass`,o.frequency.value=900+t*600;let s=e.createGain();s.gain.value=.25*t,a.connect(o).connect(s).connect(e.destination),a.start()}}}var{person:np,sections:rp,semesters:ip,skills:ap,community:op}=Ld,sp=matchMedia(`(prefers-reduced-motion: reduce)`).matches,cp=matchMedia(`(pointer: coarse)`).matches||innerWidth<760,$=e=>document.querySelector(e),lp=(e,t={},...n)=>{let r=Object.assign(document.createElement(e),t);return r.append(...n),r};dp(),$(`#open-list`).addEventListener(`click`,()=>$(`#list`).showModal()),$(`#close-list`).addEventListener(`click`,()=>$(`#list`).close()),(()=>{try{return document.createElement(`canvas`).getContext(`webgl2`)}catch{return null}})()?Promise.all([document.fonts.load(`800 64px Overpass`),document.fonts.load(`700 40px "JetBrains Mono"`)]).finally(()=>setTimeout(up,0)):(document.body.classList.add(`no-webgl`),$(`#loading`).hidden=!0,$(`#nogl`).hidden=!1,$(`#nogl-open`).addEventListener(`click`,()=>$(`#list`).showModal()),$(`#list`).showModal());function up(){let e=bf(Ld),t=new Sd({canvas:$(`#scene`),antialias:!0,powerPreference:`high-performance`});t.setPixelRatio(Math.min(devicePixelRatio,cp?1.5:1.75)),t.toneMapping=4,t.toneMappingExposure=1,t.shadowMap.enabled=!0,t.shadowMap.type=1,t.domElement.addEventListener(`webglcontextlost`,e=>{e.preventDefault(),$(`#list`).showModal()});let n=new Fn;n.background=new K(`#03050b`),n.fog=new Pn(`#050812`,.0022);let r=new js(58,1,.5,5e3),i=new Rs(`#9fb4ff`,1.1);i.castShadow=!0,i.shadow.mapSize.set(2048,2048),i.shadow.bias=-5e-4,i.shadow.normalBias=.5,Object.assign(i.shadow.camera,{left:-60,right:60,top:60,bottom:-60,near:1,far:400}),n.add(i,i.target,new ys(`#3a4f86`,`#05070c`,.9));let a=new En;{let e=3500,t=new Float32Array(e*3);for(let n=0;n<e;n++){let e=Math.random()*Math.PI*2,r=Math.acos(Math.random()*.95);t.set([Math.sin(r)*Math.cos(e)*3e3,Math.cos(r)*3e3,Math.sin(r)*Math.sin(e)*3e3],n*3)}let n=new Or;n.setAttribute(`position`,new mr(t,3)),a.add(new Zi(n,new Ki({color:`#cfd9ff`,size:1.3,sizeAttenuation:!1,fog:!1,transparent:!0,opacity:.7})));let r=new J(new aa(55,48),new ai({color:`#e8eeff`,fog:!1,toneMapped:!1}));r.position.set(-1500,900,-2e3),r.lookAt(0,0,0),a.add(r)}n.add(a);let o=xf(e.length);wf(n,o,e);let s=[],c=e.roles.find(e=>e.id===`oneimaging`),l,u;[...e.roles,e.finish].forEach(e=>{let t=o.at(e.landmarkS),r=t.n.clone().multiplyScalar(-Math.sign(e.landmarkOffset)),i;e.id===`oneimaging`?(l=Zf(),i=u=l.group):i=Nf(Mf(e.landmark,s),lf[e.id]??lf.main),i.position.copy(t.p).addScaledVector(t.n,e.landmarkOffset+(e.id===`oneimaging`?Math.sign(e.landmarkOffset)*20:0)),i.rotation.y=Math.atan2(r.x,r.z),n.add(i)});let d=$f();{let e=o.at(c.landmarkS),t=e.n.clone().multiplyScalar(Math.sign(c.landmarkOffset));d.group.position.copy(e.p).addScaledVector(t,2300).addScaledVector(e.t,900),d.group.rotation.y=Math.atan2(-t.x,-t.z),n.add(d.group)}let f=Jf(n,o,e),p=Pf();n.add(p.group);let m=new Fs(`#2ee6b6`,3,7,1.8);m.position.set(0,.3,0),p.group.add(m);let h=new Fs(`#dfe8ff`,10,14,1.5);h.position.set(0,4,-3.5),p.group.add(h);let g=new Ns(`#eaf2ff`,14,70,.42,.6,1.4);g.position.set(0,.6,2.4),g.target.position.set(0,0,30),p.group.add(g,g.target);let _=tp(),v=[-.86,.86].map(e=>{let t=new Float32Array(480),r=new Float32Array(480),i=new Or;i.setAttribute(`position`,new mr(t,3)),i.setAttribute(`color`,new mr(r,3));let a=[];for(let e=0;e<79;e++){let t=e*2;a.push(t,t+1,t+2,t+1,t+3,t+2)}i.setIndex(a);let o=new J(i,new ai({vertexColors:!0,transparent:!0,blending:2,depthWrite:!1,side:2,toneMapped:!1}));return o.frustumCulled=!1,n.add(o),{side:e,pos:t,col:r,geo:i}}),y=[],b=new jd(t);b.addPass(new Md(n,r)),b.addPass(new Pd(new U(innerWidth,innerHeight),cp?.5:.62,.4,.72)),b.addPass(new Id);let x=(t,n)=>t&&t.slot?e.offset(t,n):0,S=e=>e.slot?e.s0+e.taper+4:e.s0+4,C=()=>decodeURIComponent(location.hash.slice(1)).toLowerCase().trim(),w=e.roles.find(e=>e.id===C()),T=w?S(w)-(w.slot?18:50):30,E=w?x(w,T):0,D=o.point(T,E);o.reset(o.at(T).i);let O={x:D.p.x,z:D.p.z,heading:Math.atan2(D.t.x,D.t.z),speed:0,steer:0,braking:!1,s:T,prevS:T,lateral:E,auto:null,role:null,shake:0,finished:!1,flown:!!w&&T>S(c)+25,done:{commit:0,course:0,release:0}},k=e=>e===`course`?`course`:e===`commit`?`commit`:`release`;w&&f.list.filter(e=>e.s<T).forEach(e=>{e.hit=!0,e.skipped=!0,e.mesh.removeFromParent()});let A={commit:0,course:0,release:0};f.list.filter(e=>!e.skipped).forEach(e=>{A[k(e.kind)]++});let j=ep({scene:n,airportGroup:u,airport:l,miamiGroup:d.group,miami:d,onCaption:e=>{$(`#caption`).textContent=e,$(`#caption`).hidden=!1},onDone:()=>{$(`#fade`).classList.add(`on`),setTimeout(()=>{te(O.resumeS,0),p.group.visible=!0,$(`#caption`).hidden=!0,$(`#cutscene`).hidden=!0,document.body.classList.remove(`flying`),$(`#fade`).classList.remove(`on`),de([[`$ `,`p`],[`git switch main`,``],[`  # back on I-70 from Miami`,`dim`]])},450)}});function ee(){O.flown=!0,O.auto=null,O.speed=0,O.resumeS=O.s+.5,M.clear(),$(`#fade`).classList.add(`on`),setTimeout(()=>{p.group.visible=!1,document.body.classList.add(`flying`),$(`#cutscene`).hidden=!1,j.start(),$(`#fade`).classList.remove(`on`),de([[`$ `,`p`],[`ssh hamza@miami`,``],[`  # flying to OneImaging HQ`,`dim`]])},450)}function te(e,t){let n=o.point(e,t);Object.assign(O,{x:n.p.x,z:n.p.z,heading:Math.atan2(n.t.x,n.t.z),speed:0,s:e,prevS:e,lateral:t,auto:null}),o.reset(o.at(e).i),y.length=0}let M=new Set,ne=[`w`,`a`,`s`,`d`,`arrowup`,`arrowdown`,`arrowleft`,`arrowright`],N=e=>e.target.closest?.(`input, textarea, dialog, #journal`),re=e=>e.target.closest?.(`button, a`);addEventListener(`keydown`,e=>{if(N(e))return;let t=e.key.toLowerCase();if(j.active){[`escape`,` `,`enter`].includes(t)&&(e.preventDefault(),j.skip());return}t===` `&&re(e)||([...ne,` `].includes(t)&&e.preventDefault(),ne.includes(t)&&(M.add(t),O.auto=null),t===`n`&&ve(),t===`m`&&oe(),t===`j`&&se(),(t===`/`||t==="`")&&(e.preventDefault(),$(`#cmd`).focus()))}),addEventListener(`keyup`,e=>M.delete(e.key.toLowerCase())),addEventListener(`blur`,()=>M.clear()),document.addEventListener(`visibilitychange`,()=>{document.hidden?(M.clear(),_.pause()):_.resume()});let P={x:0,y:0,id:null,ox:0,oy:0};{let e=$(`#stick-zone`),t=$(`#stick`),n=$(`#knob`),r=()=>{P.id=null,P.x=P.y=0,t.classList.remove(`on`),n.style.transform=``};e.addEventListener(`pointerdown`,n=>{if(!(j.active||P.id!==null)){P.id=n.pointerId,P.ox=n.clientX,P.oy=n.clientY;try{e.setPointerCapture(n.pointerId)}catch{}t.style.left=`${n.clientX}px`,t.style.top=`${n.clientY-e.getBoundingClientRect().top}px`,t.classList.add(`on`),O.auto=null,$(`#stick-hint`).classList.add(`gone`),n.preventDefault()}}),e.addEventListener(`pointermove`,e=>{if(e.pointerId!==P.id)return;let t=e.clientX-P.ox,r=e.clientY-P.oy,i=Math.hypot(t,r);i>56&&(t*=56/i,r*=56/i),P.x=t/56,P.y=r/56,n.style.transform=`translate(${t}px, ${r}px)`}),[`pointerup`,`pointercancel`,`lostpointercapture`].forEach(t=>e.addEventListener(t,e=>{e.pointerId===P.id&&r()})),addEventListener(`blur`,r)}addEventListener(`hashchange`,()=>{let t=e.roles.find(e=>e.id===C());t&&ye(t)});let ie=[...e.roles].sort((e,t)=>e.s0-t.s0),ae=new Map;ie.forEach(e=>{let t=lp(`button`,{className:`branch`,textContent:e.id,title:`${e.company}, ${e.years}`});t.style.setProperty(`--c`,lf[e.id]),t.setAttribute(`aria-label`,`Drive to ${e.company}, ${e.years}`),t.addEventListener(`click`,()=>ye(e)),ae.set(e,t),$(`#branches`).append(t)}),$(`#next`).addEventListener(`click`,ve),$(`#sound`).addEventListener(`click`,oe),$(`#journal-btn`).addEventListener(`click`,se),$(`#journal-close`).addEventListener(`click`,se),$(`#finish-close`).addEventListener(`click`,()=>{$(`#finish`).hidden=!0}),$(`#finish-journal`).addEventListener(`click`,()=>{$(`#finish`).hidden=!0,$(`#journal`).hidden&&se()}),$(`#skip`).addEventListener(`click`,()=>j.skip());function oe(){let e=_.toggle();$(`#sound`).textContent=e?`Sound on`:`Sound off`,$(`#sound`).setAttribute(`aria-pressed`,e)}function se(){let e=$(`#journal`);e.hidden=!e.hidden,$(`#journal-btn`).setAttribute(`aria-expanded`,!e.hidden)}let ce=new Map,F=(e,t,n,r)=>{let i=lp(`ul`);n.forEach(e=>{let t=lp(`li`,{className:e.kind},lp(`code`,{textContent:e.hash}),` `,e.text);ce.set(e,t),i.append(t)});let a=lp(`h3`,{textContent:e});a.style.color=r,$(`#journal-body`).append(lp(`section`,{},a,lp(`p`,{className:`j-meta`,textContent:t}),i))};ie.forEach(e=>F(e.company,`${e.title}, ${e.years}`,f.list.filter(t=>t.role===e.index&&t.kind!==`community`),lf[e.id])),F(`Hackathons & community`,`Not tied to an employer`,f.list.filter(e=>e.kind===`community`),uf);function le(){$(`#c-commit`).textContent=`${O.done.commit}/${A.commit}`,$(`#c-course`).textContent=`${O.done.course}/${A.course}`,$(`#c-release`).textContent=`${O.done.release}/${A.release}`}le();let ue=$(`#term-log`);function de(e){let t=lp(`div`,{className:`tl`});for(e.forEach(([e,n,r])=>{let i=lp(`span`,{textContent:e,className:n??``});r&&(i.style.color=r),t.append(i)}),ue.append(t);ue.children.length>60;)ue.firstChild.remove();ue.scrollTop=ue.scrollHeight}de([[`$ `,`p`],[`git log --graph --all`,``],[`  # drive to write history`,`dim`]]);function fe(t,n){O.done[k(t.kind)]++,ce.get(t)?.classList.add(`done`),le();let r=e.roles[t.role];t.kind===`course`?de([[`* `,``,t.color],[t.hash+` `,`h`,t.color],[`(tag: ${t.term}) `,`dim`],[t.text,``]]):t.kind===`commit`?de([[`* `,``,t.color],[t.hash+` `,`h`,t.color],[`(${r.id}) `,``,t.color],[t.text,``]]):de([[`★ `,``,uf],[t.hash+` `,`h`,uf],[t.kind===`community`?`(release: community) `:`(release: ${r.id}) `,``,uf],[t.text,``]]),_.hit(t.kind===`course`?.3:.8),n&&t.kind!==`course`&&(O.shake=.18)}$(`#cmd-form`).addEventListener(`submit`,t=>{t.preventDefault();let n=$(`#cmd`).value.trim();if($(`#cmd`).value=``,!n)return;de([[`$ `,`p`],[n,``]]);let r=n.split(/\s+/),i=r[0]===`git`?r[1]:r[0],a=r[0]===`git`?r[2]:r[1],o=(e,t=`dim`)=>de([[e,t]]);if(i===`help`)o(`commands: git branch · git checkout <branch> · git log · whoami · contact · resume · clear`);else if(i===`branch`)ie.forEach(e=>de([[O.role===e?`* `:`  `,``],[e.id,`h`,lf[e.id]],[`  ${e.company}, ${e.years}`,`dim`]]));else if(i===`checkout`||i===`switch`){let t=e.roles.find(e=>e.id===a);t?(o(`Switched to branch '${t.id}'`),ye(t)):o(`error: pathspec '${a??``}' did not match any branch. Try: git branch`)}else if(i===`log`){let e=f.list.filter(e=>e.hit&&!e.skipped).slice(-8);e.length||o(`No commits yet. Start driving.`),e.forEach(e=>de([[e.hash+` `,`h`,e.color],[e.text,``]]))}else i===`whoami`?o(`${np.name}, ${np.role}, ${np.location}`,``):i===`contact`?o(`${np.email} · ${np.linkedin}`,``):i===`resume`||i===`cat`?$(`#list`).showModal():i===`clear`?ue.replaceChildren():o(`${i}: command not found. Type help.`);$(`#cmd`).blur()});function pe(e){let t=$(`#card`),n=lf[e.id]??`#ffd166`;t.style.setProperty(`--c`,n),t.querySelector(`.card-cmd`).textContent=e.id===`chicago`?`$ git log --graph`:`$ git show ${e.id}`,t.querySelector(`h2`).textContent=e.company,t.querySelector(`.card-role`).textContent=e.title,t.querySelector(`.card-meta`).textContent=`${e.years} · ${e.place}`,t.querySelector(`.card-blurb`).textContent=e.blurb,t.hidden=!1,t.classList.remove(`in`),t.offsetWidth,t.classList.add(`in`),clearTimeout(pe.t),cp&&(pe.t=setTimeout(()=>{t.hidden=!0},6e3)),ae.forEach((t,n)=>t.classList.toggle(`here`,n===e)),ae.get(e)?.classList.add(`seen`),$(`#sr`).textContent=`Now on ${e.company}, ${e.title}, ${e.years}.`,$(`#on-branch`).textContent=e.id===`chicago`?`main`:e.id,$(`#on-branch`).style.color=n,e.id!==`chicago`&&de([[`$ `,`p`],[e.slot?`git checkout -b ${e.id}`:`git switch main`,``],[`  # ${e.company}`,`dim`]])}function me(){if(O.s>e.finishS-10)return e.finish;let t=e.roles.filter(e=>O.s>=S(e)&&O.s<=e.s1),n=null,r=4;for(let e of t){let t=Math.abs(O.lateral-x(e,O.s));t<r&&(r=t,n=e)}if(!n){let t=e.roles.filter(e=>!e.slot&&O.s>=S(e)).at(-1);t&&Math.abs(O.lateral)<4&&(n=t)}return n}let he=$(`#graph`),I=he.getContext(`2d`),ge=[...new Set(e.roles.map(e=>e.slot))].sort((e,t)=>e-t);function _e(){let t=Math.min(devicePixelRatio,2),n=Math.round(he.clientWidth*t),r=Math.round(he.clientHeight*t);if(!n)return;(he.width!==n||he.height!==r)&&(he.width=n,he.height=r);let i=12*t,a=(n-i*2)/(ge.length-1),o=e=>i+(e/8-ge[0])*a,s=t=>r-i-t/(e.finishS+60)*(r-i*2);I.clearRect(0,0,n,r),I.lineCap=`round`,I.lineWidth=2.5*t,I.strokeStyle=`rgba(219,231,255,0.55)`,I.beginPath(),I.moveTo(o(0),s(0)),I.lineTo(o(0),s(e.finishS+60)),I.stroke(),e.roles.filter(e=>e.slot).forEach(t=>{I.strokeStyle=lf[t.id],I.beginPath();for(let n=t.s0;n<=t.s1;n+=20)(n===t.s0?I.moveTo:I.lineTo).call(I,o(e.offset(t,n)),s(n));I.stroke()});for(let e of f.list)e.kind!==`course`&&(I.fillStyle=e.hit&&!e.skipped?e.color:`#0a0e18`,I.strokeStyle=e.color,I.lineWidth=1.4*t,I.beginPath(),I.arc(o(e.lateral),s(e.s),2.4*t,0,Math.PI*2),I.fill(),I.stroke());let c=o(O.lateral),l=s(O.s);I.fillStyle=`#ffffff`,I.shadowColor=`#2ee6b6`,I.shadowBlur=10*t,I.beginPath(),I.moveTo(c,l-7*t),I.lineTo(c+5*t,l+5*t),I.lineTo(c-5*t,l+5*t),I.fill(),I.shadowBlur=0}function ve(){if(j.active)return;let t=ie.find(e=>S(e)>O.s+5);t?ye(t):O.auto={role:null,target:e.finishS+60,s:O.s,lat:O.lateral}}function ye(e){if(j.active)return;let t=S(e)+20;if(t<O.s){te(S(e)-(e.slot?18:30),x(e,S(e)-(e.slot?18:30)));return}O.auto={role:e,target:t,s:O.s,lat:O.lateral}}let be=58;function xe(){t.setSize(innerWidth,innerHeight,!1),b.setSize(innerWidth,innerHeight),r.aspect=innerWidth/innerHeight,be=innerWidth<700?68:58,r.updateProjectionMatrix()}addEventListener(`resize`,xe),xe();let Se=new Us,Ce=new W(O.x-Math.sin(O.heading)*12,5,O.z-Math.cos(O.heading)*12),we=new W,Te=new W,Ee=new K;r.position.copy(Ce),$(`#loading`).classList.add(`gone`),setTimeout(()=>{$(`#loading`).hidden=!0},600),new URLSearchParams(location.search).has(`debug`)&&(window.__hah={state:O,T:e,road:o,obstacles:f,totals:A,placeCar:te,driveTo:ye,driveToNext:ve,cut:j,keys:M,sim:e=>{j.active?j.update(e,r,0):(De(e),f.update(e,O,0,fe))}}),t.setAnimationLoop(()=>{Se.update();let e=Math.min(Se.getDelta(),.05),t=Se.getElapsed();if(sp||s.forEach(e=>e(t)),l.beacon.visible=Math.sin(t*3)>0,j.active)j.update(e,r,t);else{De(e),f.update(e,O,sp?0:t,fe),p.group.position.set(O.x,0,O.z),p.group.rotation.y=O.heading,p.group.rotation.z=-O.steer*Math.min(Math.abs(O.speed)/40,1)*.04,p.spin(O.speed*e),p.steer(O.steer),p.brake(O.braking);let n=9+Math.abs(O.speed)*.08;we.set(O.x-Math.sin(O.heading)*n,3.4+Math.abs(O.speed)*.03,O.z-Math.cos(O.heading)*n),Ce.lerp(we,sp?1:1-.001**e),r.position.copy(Ce),O.shake>0&&!sp&&(r.position.x+=(Math.random()-.5)*O.shake,r.position.y+=(Math.random()-.5)*O.shake,O.shake=Math.max(0,O.shake-e)),Te.set(O.x+Math.sin(O.heading)*10,1.4,O.z+Math.cos(O.heading)*10),r.lookAt(Te);let i=be+(sp?0:Math.min(Math.abs(O.speed),42)*.28);Math.abs(r.fov-i)>.05&&(r.fov+=(i-r.fov)*Math.min(1,e*3),r.updateProjectionMatrix());let a=lf[O.role?.id]??lf.main;y.unshift([O.x-Math.sin(O.heading)*1.5,O.z-Math.cos(O.heading)*1.5,O.heading]),y.length>80&&y.pop(),Ee.set(a);let o=Math.min(1,Math.abs(O.speed)/18);for(let e of v){for(let t=0;t<80;t++){let n=y[Math.min(t,y.length-1)],r=Math.cos(n[2]),i=-Math.sin(n[2]),a=n[0]+r*e.side,s=n[1]+i*e.side,c=.07*(1-t/80)+.01;e.pos.set([a+r*c,.2,s+i*c,a-r*c,.2,s-i*c],t*6);let l=.9*(1-t/80)*o;e.col.set([Ee.r*l,Ee.g*l,Ee.b*l,Ee.r*l,Ee.g*l,Ee.b*l],t*6)}e.geo.attributes.position.needsUpdate=!0,e.geo.attributes.color.needsUpdate=!0}m.color.set(a)}i.position.set(r.position.x-120,220,r.position.z+60),i.target.position.set(r.position.x,0,r.position.z),a.position.set(r.position.x,0,r.position.z),_.engine(j.active?0:O.speed),$(`#speed`).textContent=Math.round(Math.abs(O.speed)*3.4),_e(),b.render()});function De(t){let n=e=>Math.abs(e)<.18?0:(e-Math.sign(e)*.18)/.82,r=n(P.x),i=n(P.y),a=M.has(`w`)||M.has(`arrowup`)||i<0,s=M.has(`s`)||M.has(`arrowdown`)||i>.35,l=M.has(`a`)||M.has(`arrowleft`),u=M.has(`d`)||M.has(`arrowright`),d=i<0?Math.min(1,-i*1.15):1;if(O.prevS=O.s,O.auto){let e=O.auto,n=e.target-e.s,r=Dt.clamp(n*.7,8,36);O.speed+=(r-O.speed)*Math.min(1,t*2),e.s=Math.min(e.s+O.speed*t,o.total-5);let i=x(e.role,e.s);e.lat+=(i-e.lat)*Math.min(1,t*2.2);let a=o.point(e.s,e.lat),s=o.point(e.s+2,e.lat+(i-e.lat)*.3);O.heading=Math.atan2(s.p.x-a.p.x,s.p.z-a.p.z),O.x=a.p.x,O.z=a.p.z,O.steer=0,O.braking=!1,(n<1||e.s>=o.total-5)&&(O.auto=null,O.speed=0)}else{let n=e.lanesAt(O.s).some(e=>Math.abs(O.lateral-e)<5.5),o=n?42:16;O.braking=s&&O.speed>.5,a&&!s?O.speed+=(O.speed<0?40:22-O.speed*.25)*t*d:s&&a?O.speed=Math.max(0,O.speed-40*t):s?O.speed-=(O.speed>0?40:16)*t:O.speed*=(n?.7:.3)**t,i<0&&O.speed>o*d+2&&(O.speed+=(o*d-O.speed)*Math.min(1,t*1.5)),O.speed>o&&(O.speed+=(o-O.speed)*Math.min(1,t*3)),O.speed=Math.max(O.speed,-14),Math.abs(O.speed)<.1&&!a&&!s&&(O.speed=0);let c=Dt.clamp(!!l-+!!u-r*1.1,-1,1);O.steer+=(c-O.steer)*Math.min(1,t*8);let f=Math.min(1,Math.abs(O.speed)/6)*(1-Math.min(Math.abs(O.speed),42)/100);O.heading+=O.steer*2*t*f*Math.sign(O.speed||1),O.x+=Math.sin(O.heading)*O.speed*t,O.z+=Math.cos(O.heading)*O.speed*t}let f=o.nearest(O);O.s=f.sample.s,O.lateral=(O.x-f.sample.p.x)*f.sample.n.x+(O.z-f.sample.p.z)*f.sample.n.z;let p=e.lanesAt(O.s),m=3.05,h=p[0],g=1/0;for(let e of p){let t=Math.abs(O.lateral-e);t<g&&(g=t,h=e)}let _=Math.min(...p)-m,v=Math.max(...p)+m,y=(O.x-f.sample.p.x)*f.sample.t.x+(O.z-f.sample.p.z)*f.sample.t.z,b=0,C=0;if(!O.auto&&(O.lateral<_||O.lateral>v)){b=Dt.clamp(O.lateral,_,v)-O.lateral;let e=f.sample.heading,n=Math.atan2(Math.sin(O.heading-e),Math.cos(O.heading-e)),r=Math.abs(n)<Math.PI/2?e:e+Math.PI,i=Math.atan2(Math.sin(O.heading-r),Math.cos(O.heading-r));O.heading=r+i*.8,O.speed*=.35**t,Math.abs(b)>.05&&(O.shake=Math.max(O.shake,Math.min(.12,Math.abs(O.speed)*.004)))}f.sample.i===0&&y<-2&&(C=-2-y),f.sample.s>o.total-3&&y>2&&(C=2-y),(b||C)&&(O.x+=f.sample.n.x*b+f.sample.t.x*C,O.z+=f.sample.n.z*b+f.sample.t.z*C,C&&(O.speed=0),f=o.nearest(O),O.s=f.sample.s,O.lateral=(O.x-f.sample.p.x)*f.sample.n.x+(O.z-f.sample.p.z)*f.sample.n.z),Math.min(...e.lanesAt(O.s).map(e=>Math.abs(O.lateral-e)))>8&&te(O.s,h);let w=me();w&&w!==O.role&&(O.role=w,pe(w)),!O.flown&&O.role===c&&O.s>S(c)+25&&ee(),!O.finished&&O.s>e.finishS+50&&(O.finished=!0,$(`#finish-count`).textContent=`You wrote ${O.done.commit} of ${A.commit} commits, tagged ${O.done.course} of ${A.course} courses, and shipped ${O.done.release} of ${A.release} releases. Anything missed is in another lane; the journal lists it.`,$(`#finish`).hidden=!1,$(`#finish .btn-solid`).focus({preventScroll:!0})),O.s>T+60&&$(`#hint`).classList.add(`gone`)}}function dp(){let e=$(`#list-body`),t=lp(`p`,{className:`list-contact`},lp(`a`,{href:`mailto:${np.email}`,textContent:np.email}),lp(`a`,{href:np.linkedin,textContent:`LinkedIn`,rel:`me noopener`,target:`_blank`}),lp(`a`,{href:np.github,textContent:`GitHub`,rel:`me noopener`,target:`_blank`}));e.append(lp(`header`,{},lp(`h2`,{textContent:np.name}),lp(`p`,{className:`list-role`,textContent:`${np.role}, ${np.location}`}),lp(`p`,{textContent:np.summary}),t)),[...rp].sort((e,t)=>t.start.localeCompare(e.start)).forEach(t=>{e.append(lp(`section`,{},lp(`h3`,{textContent:t.company}),lp(`p`,{className:`list-role`,textContent:[t.title,t.years,t.place].filter(Boolean).join(`, `)}),lp(`ul`,{},...t.obstacles.map(([,e])=>lp(`li`,{textContent:e})))))}),e.append(lp(`section`,{},lp(`h3`,{textContent:`Hackathons & community`}),lp(`ul`,{},...op.map(([,e])=>lp(`li`,{textContent:e}))))),e.append(lp(`section`,{},lp(`h3`,{textContent:`Kansas State coursework`}),...ip.map(e=>lp(`p`,{className:`list-courses`},lp(`strong`,{textContent:`${e.term}${e.honors?` (semester honors)`:``}: `}),e.courses.map(([e,t])=>`${e} ${t}`).join(`, `))))),e.append(lp(`section`,{},lp(`h3`,{textContent:`Skills`}),lp(`dl`,{className:`list-skills`},...ap.flatMap(([e,t])=>[lp(`dt`,{textContent:e}),lp(`dd`,{textContent:t})])))),$(`#linkedin`).href=np.linkedin,fp()}function fp(){let e=np.email,t=`Hello%20from%20hahmed.dev`;$(`#mail-addr`).textContent=e,$(`#mail-gmail`).href=`https://mail.google.com/mail/?view=cm&fs=1&to=${encodeURIComponent(e)}&su=${t}`,$(`#mail-outlook`).href=`https://outlook.live.com/mail/0/deeplink/compose?to=${encodeURIComponent(e)}&subject=${t}`,$(`#mail-app`).href=`mailto:${e}?subject=${t}`;let n=$(`#mail`),r=e=>{e?.stopPropagation(),n.hidden=!1,$(`#mail-copy`).focus({preventScroll:!0})},i=()=>{n.hidden=!0};$(`#contact`).addEventListener(`click`,e=>n.hidden?r(e):i()),document.querySelectorAll(`.mail-open`).forEach(e=>e.addEventListener(`click`,e=>{$(`#finish`).hidden=!0,r(e)})),$(`#mail-close`).addEventListener(`click`,i),addEventListener(`keydown`,e=>{e.key===`Escape`&&!n.hidden&&i()}),document.addEventListener(`pointerdown`,e=>{!n.hidden&&!n.contains(e.target)&&e.target!==$(`#contact`)&&i()}),$(`#mail-copy`).addEventListener(`click`,async()=>{let t=!1;try{await navigator.clipboard.writeText(e),t=!0}catch{let e=document.createRange();e.selectNodeContents($(`#mail-addr`));let n=getSelection();n.removeAllRanges(),n.addRange(e);try{t=document.execCommand(`copy`)}catch{t=!1}}$(`#mail-copy`).textContent=t?`Copied`:`Select and copy`,setTimeout(()=>{$(`#mail-copy`).textContent=`Copy`},2e3)})}