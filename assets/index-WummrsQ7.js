...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function ec(e,t,n){return new vo({name:`SphericalGaussianBlur`,defines:{SAMPLES:zs,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},sigma:{value:0},mipInt:{value:0}},vertexShader:rc(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function tc(){return new vo({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:rc(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function nc(){return new vo({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:rc(),fragmentShader:`
	...
	`}var ic=class extends Wt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new Ai(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
		...
		}`};var Wu={name:`Hamza Ahmed`,role:`Staff Software Engineer, AI/ML Solutions Architect`,location:`Chicago, IL`,email:`hahmed149@outlook.com`,linkedin:`https://www.linkedin.com/in/hahmed149/`,github:`https://github.com/hahmed149`,summary:`I build enterprise AI platforms and healthcare software: HIPAA-scoped AI agents on AWS Bedrock, scheduling integrations, and the testing and migration foundations that let teams ship safely.`},Gu=[{term:`Fall 2014`,courses:[[`ECE 210`,`Intro to Electrical Engineering`],[`ENGL 100`,`Expository Writing`],[`MATH 220`,`Calculus 1`],[`MC 110`,`Mass Communication in Society`],[`CIS 101`,`Intro to Computing Systems`],[`CIS 104`,`Intro to Word Processing`]]},{term:`Spring 2015`,courses:[[`CHM 210`,`Chemistry 1`],[`ECE 115`,`New Student Design Project`],[`ECE 241`,`Intro to Computer Engineering`],[`ECON 110`,`Macroeconomics`],[`MATH 221`,`Calculus 2`]]},{term:`Summer 2015`,courses:[[`PHYS 213`,`Engineering Physics 1`]]},{term:`Fall 2015`,courses:[[`CIS 200`,`Programming Fundamentals`],[`ECE 410`,`Circuit Theory 1`],[`GEOL 100`,`Earth in Action`],[`MATH 240`,`Differential Equations`]]},{term:`Spring 2016`,courses:[[`CIS 300`,`Data & Program Structures`],[`ECE 441`,`Design of Digital Systems`],[`ECE 511`,`Circuit Theory 2`],[`STAT 510`,`Probability & Statistics`],[`COMM 106`,`Public Speaking`]]},{term:`Fall 2016`,honors:!0,courses:[[`ECE 431`,`Microcontrollers`],[`ECE 525`,`Electronics 1`],[`ENTRP 340`,`Entrepreneurship`],[`MANGT 420`,`Management Concepts`]]},{term:`Spring 2017`,honors:!0,courses:[[`CIS 308`,`C/C++ Language Lab`],[`CIS 501`,`Software Architecture & Design`],[`ECE 540`,`Applied Scientific Computing`],[`GEOL 125`,`Natural Disasters`],[`MATH 510`,`Discrete Mathematics`]]},{term:`Fall 2017`,honors:!0,courses:[[`ECE 542`,`Computer Networking`],[`ECE 643`,`Computer Engineering Design Lab`],[`ECE 649`,`Computer Design 1`],[`ENGL 415`,`Written Communication for Engineers`]]},{term:`Spring 2018`,honors:!0,courses:[[`CIS 520`,`Operating Systems`],[`ECE 512`,`Linear Systems`],[`ECE 590`,`Senior Design 1`],[`ECE 631`,`Microcomputer System Design`],[`ECE 645`,`Digital Electronics`],[`COMM 332`,`Communication & Technology`]]},{term:`Summer 2018`,courses:[[`ECE 690`,`Problems in Electrical Engineering`]]},{term:`Fall 2018`,courses:[[`ARCH 301`,`Appreciation of Architecture`],[`CIS 115`,`Intro to Computing Science`],[`CIS 301`,`Logical Foundations of Programming`],[`ECE 557`,`Electromagnetic Theory`],[`ECE 591`,`Senior Design 2`]]}],Ku=[{id:`ksu`,kind:`campus`,landmark:`campus`,years:`2014–2018`,company:`Kansas State University`,place:`Manhattan, KS`,title:`B.S. Computer Engineering, minor in Computer Science`,blurb:`Every course is a cone at its semester gate. Drive through each gate to finish the term.`,obstacles:[[`IEEE president`,`President of the IEEE student chapter (2018).`],[`Hack K-State`,`Won Hack K-State (2017).`],[`Graduated`,`Graduated December 2018 with a B.S. in Computer Engineering and a minor in Computer Science.`]]},{id:`collegian`,landmark:`press`,years:`2015–2018`,company:`Collegian Media Group`,place:`Manhattan, KS`,title:`IT Specialist, then IT Support Manager`,blurb:`Ran IT for the student newspaper while in school.`,obstacles:[[`100 Macs`,`Kept a network of about 100 Mac workstations running for 65+ faculty, staff, and students.`],[`kstatecollegian.com`,`Redesigned and ran kstatecollegian.com, including traffic management.`],[`Promoted`,`Promoted to IT Support Manager in 2017.`],[`Hired a team`,`Interviewed, hired, and led the IT support staff.`],[`Tech of the Year`,`Named Tech of the Year (2017).`]]},{id:`softek`,landmark:`office`,years:`2018`,company:`Softek Illuminate`,place:`Overland Park, KS`,title:`Software Engineering Intern`,blurb:`First engineering job, on the Insight application.`,obstacles:[[`Export / import`,`Built export and import components for the Insight application.`],[`French l10n`,`Added French localization to the Insight UI.`],[`Bug bash`,`Found and fixed bugs across the app to improve reliability.`]]},{id:`cerner`,landmark:`cerner`,years:`2019–2020`,company:`Cerner Corporation`,place:`Kansas City, MO`,title:`Software Engineer`,blurb:`Patient flow and hospital capacity software on the CareAware platform.`,obstacles:[[`Capacity Mgmt`,`Led development of CareAware Capacity Management for patient flow and tracking.`],[`Command Center`,`Planned and built the CareAware Command Center Dashboard for real-time hospital operations.`],[`ML census model`,`Integrated an inpatient-census prediction model with the ML team to improve bed utilization.`],[`New Relic`,`Added New Relic monitoring and tracing, cutting time to resolve production issues.`],[`K8s + Spinnaker`,`Shipped cloud services as Docker containers through Kubernetes and Spinnaker pipelines.`],[`Mentored 8`,`Mentored 8 engineers through DevAcademy, Cerner’s software boot camp.`],[`Night on the Town`,`Won the Night on the Town award for team collaboration (2019).`]]},{id:`rxss`,landmark:`rxss`,years:`2020–2025`,company:`Rx Savings Solutions / McKesson`,place:`Overland Park, KS`,title:`Software Engineer → Senior Software Engineer & Technical Lead`,blurb:`Prescription savings software. McKesson acquired RxSS in November 2022.`,obstacles:[[`Health plan viz`,`Built health plan data visualizations for the pharmacy support team.`],[`Nightly scans`,`Automated nightly scans to detect data changes and alert administrators.`],[`S3 + CloudFront CMS`,`Built a content management system on AWS S3 and CloudFront.`],[`Terraform`,`Introduced Terraform so application stacks deploy the same way in every environment.`],[`Azure AD SSO`,`Integrated Azure AD single sign-on.`],[`Promoted`,`Promoted to Senior Software Engineer and Technical Lead (2022).`],[`Private Label Mgr`,`Shipped Private Label Manager, saving an estimated 2,000 engineering hours.`],[`Unified Auth`,`Architected unified auth on Auth0 across the Member Portal, AdminRx, and mobile.`],[`MFA rollout`,`Designed MFA enrollment with feature-flagged rollout by user group.`],[`Zero downtime`,`Led a zero-downtime migration off legacy auth, with self-service password reset.`],[`Dev Academy`,`Founded and led Dev Academy, training new engineers in PHP and JavaScript.`],[`GitLab move`,`Moved Bitbucket to GitLab and rebuilt CI/CD and Terraform to cut deploy times.`],[`Vue 2 → 3`,`Led the Vue 2 to Vue 3 modernization.`],[`Demo mode`,`Built a MirageJS demo mode so sales could run custom demos.`],[`Hackathon 2nd`,`Took 2nd place at the RxSS Hackathon with prescriber fax automation (2022).`],[`Wolverine Award`,`Won the peer-nominated Wolverine Award (2022).`]]},{id:`fluxpilot`,landmark:`bess`,years:`2022–now`,company:`Fluxpilot`,place:`Chicago, IL`,title:`Co-Founder`,blurb:`Software that sizes and lays out utility-scale battery energy storage projects.`,obstacles:[[`BESS sizing`,`Built the battery energy storage sizing framework.`],[`Electron app`,`Built the Electron desktop app and its release process.`],[`Local-first`,`Kept project data on the user’s machine by running the desktop app locally.`],[`AI sizing tools`,`Shipped a serverless web app with AI-assisted sizing tools.`],[`Faster bids`,`Made design iterations faster and repeatable, cutting engineering effort during bids.`]]},{id:`annovox`,landmark:`factory`,years:`2024–now`,company:`Annovox AI`,place:`St. Joseph, MO`,title:`Chief Technology Officer`,blurb:`Turns expert video recordings into factory-floor training.`,obstacles:[[`AI work orders`,`Generated editing work orders from subject-matter-expert feedback with OpenAI.`],[`MediaConvert`,`Automated video processing and editor assignment with AWS MediaConvert.`],[`QR access`,`Gave factory workers QR-code access to training.`],[`Offline streaming`,`Delivered adaptive streaming with offline viewing for industrial networks.`],[`5-role RBAC`,`Built multi-tenant access control for five user types, with audit trails.`]]},{id:`nac`,landmark:`capitol`,years:`2025`,company:`National Accreditation Commission`,place:`Remote, for the State of Arkansas`,title:`Interim Chief Technology Officer`,blurb:`An AI compliance platform for workforce Pell grants and institution accreditation.`,obstacles:[[`Graph RAG`,`Built hybrid Graph RAG verification that cut manual review time by 75%.`],[`90% accuracy`,`Reached 90% compliance-detection accuracy.`],[`15-min checks`,`Designed event-driven serverless processing for 15-minute asynchronous compliance checks.`],[`Governor’s office`,`Worked with the Chief Data Officer for the Office of the Governor of Arkansas.`],[`OpenAI HQ`,`Presented at OpenAI × GitLab Foundation Demo Day at OpenAI headquarters in San Francisco.`],[`Mentored 4`,`Mentored 4 George Washington University master’s students in AI and RAG.`]]},{id:`addi`,landmark:`billboards`,years:`2025–2026`,company:`Addi`,place:`Kansas City, remote`,title:`Senior Software Engineer (contract)`,blurb:`Tools for small businesses to manage and publish AI-generated ad campaigns.`,obstacles:[[`Campaign UI`,`Built the Addi interface for managing AI-generated ad campaigns.`],[`Meta Ads`,`Built the Meta Ads publishing integration.`],[`TikTok Ads`,`Built the TikTok Ads publishing integration.`],[`Google + YouTube`,`Built the Google Ads and YouTube Ads integrations.`],[`Spotify Ads`,`Built the Spotify Ads integration.`]]},{id:`oneimaging`,landmark:`imaging`,years:`2026–now`,company:`OneImaging`,place:`Remote`,title:`Staff Software Engineer`,blurb:`Patient imaging scheduling and care coordination.`,obstacles:[[`OI Investigator`,`Shipped OI Investigator, a HIPAA-scoped AI agent (Claude on Bedrock, ECS Fargate) that root-causes support tickets.`],[`200+ tickets`,`OI Investigator triaged 200+ tickets in its first two months.`],[`800+ hours`,`Saved an estimated 800+ engineering hours of manual investigation.`],[`RIS integration`,`Led the AdvancedMD RIS integration for real-time, multi-facility availability.`],[`Jumpstart`,`Delivered Jumpstart, fast-path booking against pending orders.`],[`Playwright gate`,`Built the first Playwright end-to-end suite as a blocking pre-merge gate.`],[`Flyway migrations`,`Architected Flyway migrations with unsafe-DDL linting and drift detection.`],[`Support rotation`,`Set up the engineering support rotation and triage process.`],[`Flags + analytics`,`Added feature flags and improved product analytics in Amplitude.`],[`Fax callbacks`,`Reworked the fax integration to use callbacks for faster sending and receiving.`],[`Agentic harness`,`Building an agentic development harness with automated end-to-end checks.`]]},{id:`chicago`,landmark:`chicago`,years:`Now`,company:`Chicago, IL`,place:`Home base`,title:`Where the road is today`,blurb:`Hackathons, awards, and the skills picked up along the way.`,obstacles:[[`HackMidwest 1st`,`HackMidwest 2024: Taini, a voice AI accountability coach. 1st place, Best in AI from AWS.`],[`HackMidwest 3rd`,`HackMidwest 2023: CareCue, a chatbot for caregivers. 3rd place.`],[`Spotlight Award`,`Employee Spotlight Award for a technical talk at the CoverMyMeds conference.`],[`FLL mentor`,`Mentored the ICJC Mavericks First Lego League team (2023).`]]}],qu=[[`AI / ML`,`Amazon Bedrock, Claude, OpenAI, AI agents, LangChain, Graph RAG, Neo4j, Pinecone, guardrails, evals`],[`Healthcare`,`HL7, X12 EDI (837/270/271/835), AdvancedMD RIS, HIPAA`],[`Cloud`,`AWS, ECS Fargate, Lambda, EventBridge, Serverless, SST, Terraform`],[`Backend`,`Node.js, PHP, Python, FastAPI, Express, Spring Boot, Java`],[`Frontend`,`React, Vue 3, TypeScript, Electron, PWAs`],[`Data`,`Aurora PostgreSQL, MySQL, MongoDB, DynamoDB, Redis, Flyway`],[`Delivery`,`GitHub Actions, GitLab CI, Docker, Kubernetes, Playwright, Testcontainers`],[`Security`,`Auth0, OAuth 2.0, SAML, Azure AD, Cognito, MFA, WAF`]],Ju=`"Overpass", system-ui, sans-serif`;function Yu(e,t){let n=document.createElement(`canvas`);return n.width=e,n.height=t,[n,n.getContext(`2d`)]}function Xu(t,n=[1,1]){let r=new ji(t);return r.colorSpace=Pe,r.wrapS=r.wrapT=e,r.repeat.set(...n),r.anisotropy=8,r}var Zu=7,Qu=()=>(Zu=Zu*16807%2147483647)/2147483647,$u=new Map;function ed({wall:e=`#6f7b86`,glass:t=`#2b3a48`,lit:n=`#ffe6a8`,frame:r=null,cols:i=4,rows:a=4,glassy:o=!1}={}){let s=JSON.stringify(arguments[0]??{});if($u.has(s))return $u.get(s);let[c,l]=Yu(256,256);l.fillStyle=e,l.fillRect(0,0,256,256);let u=256/i,d=256/a;for(let e=0;e<a;e++)for(let a=0;a<i;a++){let i=o?2:u*.18,s=o?2:d*.22,c=l.createLinearGradient(0,e*d,0,(e+1)*d),f=Qu()<.03,p=Qu()*30;c.addColorStop(0,f?n:cd(t,55+p)),c.addColorStop(.55,f?cd(n,-20):cd(t,18+p*.5)),c.addColorStop(1,f?cd(n,-40):t),l.fillStyle=c,l.fillRect(a*u+i,e*d+s,u-i*2,d-s*2),r&&(l.strokeStyle=r,l.lineWidth=2,l.strokeRect(a*u+i,e*d+s,u-i*2,d-s*2))}let f=Xu(c);return $u.set(s,f),f}function td(e=`#d9ccb1`){let[t,n]=Yu(256,256);n.fillStyle=e,n.fillRect(0,0,256,256);for(let t=0;t<8;t++){let r=t%2?24:0;for(let i=-r;i<256;i+=48)n.fillStyle=cd(e,(Qu()-.5)*22),n.fillRect(i+1,t*32+1,46,30)}for(let e=0;e<1400;e++)n.fillStyle=`rgba(60,50,30,${Qu()*.08})`,n.fillRect(Qu()*256,Qu()*256,2,2);return Xu(t)}function nd(e=`#8e4a36`){let[t,n]=Yu(256,256);n.fillStyle=`#cbbfae`,n.fillRect(0,0,256,256);for(let t=0;t<16;t++){let r=t%2?16:0;for(let i=-r;i<256;i+=32)n.fillStyle=cd(e,(Qu()-.5)*30),n.fillRect(i+1,t*16+1,30,14)}return Xu(t)}function rd(){let[e,t]=Yu(512,512);t.fillStyle=`#34363a`,t.fillRect(0,0,512,512);for(let e=0;e<9e3;e++){let e=40+Qu()*40;t.fillStyle=`rgba(${e},${e},${e+4},${.25+Qu()*.4})`,t.fillRect(Qu()*512,Qu()*512,1.5,1.5)}return t.fillStyle=`#e9e6dc`,t.fillRect(18,0,10,512),t.fillRect(484,0,10,512),t.fillStyle=`#e8b923`,t.fillRect(246,0,7,512),t.fillRect(259,0,7,512),t.fillStyle=`rgba(0,0,0,0.12)`,t.fillRect(110,0,50,512),t.fillRect(352,0,50,512),Xu(e)}function id(e,{w:t=512,h:n=160,bg:r=`#0b6b3a`,fg:i=`#f7f9f4`,border:a=!0,weight:o=800}={}){let[s,c]=Yu(t,n);c.fillStyle=r,c.beginPath(),c.roundRect(0,0,t,n,n*.14),c.fill(),a&&(c.strokeStyle=i,c.lineWidth=n*.045,c.beginPath(),c.roundRect(n*.07,n*.07,t-n*.14,n-n*.14,n*.1),c.stroke()),c.fillStyle=i,c.textAlign=`center`,c.textBaseline=`middle`;let l=e.length;return e.forEach((e,r)=>{let i=r===0?n*(l>1?.36:.5):n*.22;for(c.font=`${r===0?o:600} ${i}px ${Ju}`;c.measureText(e).width>t-n*.4&&i>8;)i-=2,c.font=`${r===0?o:600} ${i}px ${Ju}`;let a=l===1?n/2:n*(.38+(r-(l-1)/2)*.34)+(r===0?0:n*.06);c.fillText(e,t/2,a+n*.03)}),Xu(s)}function ad(){let[e,t]=Yu(256,64);t.fillStyle=`#f7f4ee`,t.fillRect(0,0,256,64),t.fillStyle=`#f06a1b`;for(let e=-64;e<320;e+=48)t.beginPath(),t.moveTo(e,64),t.lineTo(e+24,64),t.lineTo(e+88,0),t.lineTo(e+64,0),t.fill();return Xu(e)}function od(e,t,n){let[r,i]=Yu(1024,400),a=i.createLinearGradient(0,0,1024,400);return a.addColorStop(0,n),a.addColorStop(1,cd(n,-40)),i.fillStyle=a,i.fillRect(0,0,1024,400),i.fillStyle=`#ffffff`,i.textAlign=`left`,i.textBaseline=`alphabetic`,i.font=`800 120px ${Ju}`,i.fillText(e,60,200),i.font=`600 52px ${Ju}`,i.fillText(t,64,290),Xu(r)}function sd(e,t=`#101826`){let[n,r]=Yu(1024,576);return r.fillStyle=t,r.fillRect(0,0,1024,576),r.fillStyle=`#f7f9f4`,r.textAlign=`center`,r.font=`800 96px ${Ju}`,r.fillText(e[0],512,270),r.font=`600 44px ${Ju}`,r.fillText(e[1]??``,512,350),Xu(n)}function cd(e,t){let n=parseInt(e.slice(1),16),r=e=>Math.max(0,Math.min(255,e+t));return`rgb(${r(n>>16)},${r(n>>8&255)},${r(n&255)})`}var ld=75;function ud(e,t){let n=Math.sin(e*127.1+t*311.7)*43758.5453;return n-Math.floor(n)}function dd(e,t){let n=Math.floor(e),r=Math.floor(t),i=e-n,a=t-r,o=i*i*(3-2*i),s=a*a*(3-2*a),c=ud(n,r),l=ud(n+1,r),u=ud(n,r+1),d=ud(n+1,r+1);return c+(l-c)*o+(u-c)*s+(c-l-u+d)*o*s}function fd(e,t){return dd(e,t)*.55+dd(e*2.03,t*2.03)*.28+dd(e*4.1,t*4.1)*.12+dd(e*8.3,t*8.3)*.05}var pd=(e,t=0)=>ud(e*1.37+t*9.1,t*3.7+e*.13);function md(e,t){let n=60;return{plan:e.map((e,r)=>{let i=n,a=[];n+=90,e.kind===`campus`&&t.forEach((e,t)=>{a.push({type:`gate`,s:n,sem:e,index:t}),n+=32}),e.obstacles.forEach(([e,t],r)=>{a.push({type:`barricade`,s:n,label:e,text:t,index:r}),n+=26}),n+=60;let o=n;return n+=120,{...e,start:i,end:n,landmarkS:o,items:a,side:r%2?-1:1}}),length:n+80}}function hd(e){let t=[],n=0,r=0,i;for(let a=0;a<=e+20;a+=20)t.push(new K(n,0,r)),i=Math.PI+1.05*Math.sin(a/430)+.35*Math.sin(a/157+1.3),n+=Math.sin(i)*20,r+=Math.cos(i)*20;let a=new Xi(t,!1,`centripetal`),o=a.getLength(),s=Math.ceil(o/1.5),c=[];for(let e=0;e<=s;e++){let t=e/s,n=a.getPointAt(t),r=a.getTangentAt(t);c.push({i:e,u:t,s:t*o,p:n,t:r,n:new K(-r.z,0,r.x),heading:Math.atan2(r.x,r.z)})}let l=e=>c[Ct.clamp(Math.round(e/o*s),0,s)],u=0;function d(e,t=!1){let n=u,r=1/0,i=t?0:Math.max(0,u-120),a=t?s:Math.min(s,u+120);for(let t=i;t<=a;t++){let i=c[t].p,a=(i.x-e.x)**2+(i.z-e.z)**2;a<r&&(r=a,n=t)}return!t&&r>900?d(e,!0):(u=n,{sample:c[n],dist:Math.sqrt(r)})}return{curve:a,samples:c,total:o,at:l,nearest:d,reset:e=>{u=e}}}function gd(e,t,n,r){let i=[],a=[],o=[];e.forEach((e,s)=>{if(i.push(e.p.x+e.n.x*t/2,n,e.p.z+e.n.z*t/2,e.p.x-e.n.x*t/2,n,e.p.z-e.n.z*t/2),a.push(0,e.s/r,1,e.s/r),s>0){let e=(s-1)*2;o.push(e,e+2,e+1,e+1,e+2,e+3)}});let s=new Tr;return s.setAttribute(`position`,new pr(i,3)),s.setAttribute(`uv`,new pr(a,2)),s.setIndex(o),s.computeVertexNormals(),s}function _d(e,t,n){let{samples:r}=t,i=r.filter((e,t)=>t%8==0),a=e=>n.find(t=>e<t.end)??n.at(-1),o=(e,t)=>{let n=1/0,r=i[0];for(let a of i){let i=(a.p.x-e)**2+(a.p.z-t)**2;i<n&&(n=i,r=a)}return{d:Math.sqrt(n),s:r}},s=new Kn().setFromPoints(r.map(e=>e.p)),c=s.max.x-s.min.x+900,l=s.max.z-s.min.z+900,u=(s.max.x+s.min.x)/2,d=(s.max.z+s.min.z)/2,f=new oo(c,l,Math.round(c/11),Math.round(l/11));f.rotateX(-Math.PI/2),f.translate(u,0,d);let p=f.attributes.position,m=[],h={wheat:new J(`#c9a95c`),grass:new J(`#6f8f45`),lawn:new J(`#5f8f3e`),dry:new J(`#a79a62`),city:new J(`#8e8f86`)},g=(e,t,n)=>fd(e*.006,t*.006)*70*Ct.smoothstep(n,ld,235),_=new J;for(let e=0;e<p.count;e++){let t=p.getX(e),n=p.getZ(e),{d:r,s:i}=o(t,n);p.setY(e,g(t,n,r)-.08);let s=a(i.s),c=fd(t*.01+17,n*.01);s.id===`ksu`||s.id===`collegian`?_.copy(h.lawn).lerp(h.grass,c):[`cerner`,`rxss`,`chicago`].includes(s.id)&&r<130?_.copy(h.city).lerp(h.grass,Ct.smoothstep(r,60,130)):_.copy(c>.5?h.grass:h.wheat).lerp(h.dry,fd(t*.04,n*.04)*.5),_.offsetHSL(0,0,(ud(t,n)-.5)*.04),m.push(_.r,_.g,_.b)}f.setAttribute(`color`,new pr(m,3)),f.computeVertexNormals();let v=new Y(f,new bo({vertexColors:!0,roughness:1}));v.receiveShadow=!0,e.add(v);let y=new Y(gd(r,11,.05,17.6),new bo({map:rd(),roughness:.92})),b=new Y(gd(r,14,.02,20),new bo({color:`#8b8579`,roughness:1}));y.receiveShadow=b.receiveShadow=!0,e.add(b,y);let x=r.filter(e=>e.s%70<1.5),S=new Ri(.12,.18,8,6).translate(0,4,0),C=new Fi(.12,.12,2.6).translate(0,8,1.2),w=new Fi(.5,.18,.9).translate(0,7.9,2.4),T=new bo({color:`#8d949b`,metalness:.7,roughness:.4}),E=new bo({color:`#fff4d6`,emissive:`#fff0c0`,emissiveIntensity:.6}),D=new Ti(S,T,x.length),O=new Ti(C,T,x.length),k=new Ti(w,E,x.length),A=new qt,j=new wt,M=new K(1,1,1),N=new K(0,1,0);x.forEach((e,t)=>{let n=t%2?1:-1,r=e.p.clone().addScaledVector(e.n,n*7.7);j.setFromAxisAngle(N,Math.atan2(-e.n.x*n,-e.n.z*n)),A.compose(r,j,M),D.setMatrixAt(t,A),O.setMatrixAt(t,A),k.setMatrixAt(t,A)}),D.castShadow=!0,e.add(D,O,k),n.forEach(n=>{let r=n.years===`Now`?`Now`:`Exit ${n.years.slice(0,4)}`;e.add(vd(t.at(n.start+30),[n.company,n.place],r))});let P=n.map(e=>{let n=t.at(e.landmarkS);return{p:n.p.clone().addScaledVector(n.n,e.side*50),r:62}}),F=[{wall:`#7d8a96`,glass:`#23313f`,cols:4,rows:6},{wall:`#a39a8b`,glass:`#34414c`,cols:5,rows:6,frame:`#cfc6b6`},{wall:`#3d4a57`,glass:`#5a7f9e`,cols:6,rows:8,glassy:!0},{wall:`#b6aea1`,glass:`#2e3b46`,cols:3,rows:5}],I=new bo({color:`#55595e`,roughness:.9});n.filter(e=>[`softek`,`cerner`,`rxss`,`oneimaging`,`chicago`].includes(e.id)).forEach((n,r)=>{let i=n.id===`chicago`?2.2:n.id===`cerner`||n.id===`rxss`?1.3:.7;for(let a=n.start+60;a<n.end-20;a+=34/i)for(let i of[-1,1]){let s=Math.floor(a*7+i*3+r);if(pd(s,1)<.25)continue;let c=t.at(a),l=26+pd(s,2)*60,u=c.p.clone().addScaledVector(c.n,i*l);if(P.some(e=>e.p.distanceTo(u)<e.r)||o(u.x,u.z).d<22)continue;let d=10+pd(s,3)*12,f=10+pd(s,4)*12,p=(n.id===`chicago`?20+pd(s,5)**2*110:8+pd(s,5)**2*45)*(l<50?.7:1),m=F[s%F.length],h=ed(m).clone();h.needsUpdate=!0,h.repeat.set(Math.max(1,Math.round(d/8)),Math.max(1,Math.round(p/12)));let g=new bo({map:h,roughness:m.glassy?.25:.8,metalness:m.glassy?.5:.05}),_=new Y(new Fi(d,p,f),[g,g,I,I,g,g]);_.position.set(u.x,p/2,u.z),_.rotation.y=c.heading,_.castShadow=_.receiveShadow=!0,e.add(_)}});let ee=[],L=[],te=Math.round(c*l/900);for(let e=0;e<te;e++){let t=s.min.x-450+pd(e,11)*c,n=s.min.z-450+pd(e,12)*l,r=o(t,n);if(r.d<16)continue;let i=a(r.s.s);if([`cerner`,`rxss`,`chicago`].includes(i.id)&&r.d<120&&pd(e,13)>.15||fd(t*.012,n*.012)<(r.d<ld?.55:.45)||P.some(e=>Math.hypot(e.p.x-t,e.p.z-n)<e.r))continue;let u=g(t,n,r.d);(pd(e,14)<.35?L:ee).push([t,u,n,.8+pd(e,15)*.9,pd(e,16)])}let ne=new Ri(.22,.38,3,6).translate(0,1.5,0),re=new io(2.6,1).translate(0,4.6,0),ie=new io(1.9,1).translate(1.2,5.6,.6),ae=new zi(2,7,7).translate(0,5,0),R=new bo({color:`#5b4330`,roughness:1}),oe=new bo({color:`#4f7a36`,roughness:.9,flatShading:!0}),se=new bo({color:`#5f8a3a`,roughness:.9,flatShading:!0}),ce=new bo({color:`#2f5a33`,roughness:.9,flatShading:!0}),le=(t,n,r,i=1)=>{let a=new Ti(t,n,r.length);r.forEach(([e,t,n,r,o],s)=>{j.setFromAxisAngle(N,o*6.28),A.compose(new K(e,t,n),j,new K(r,r*i,r)),a.setMatrixAt(s,A)}),a.castShadow=!0,e.add(a)};return le(ne,R,ee),le(re,oe,ee),le(ie,se,ee),le(ne,R,L),le(ae,ce,L,1.2),{sectionAt:a,heightAt:g,bounds:{box:s,W:c,D:l,cx:u,cz:d}}}function vd(e,t,n){let r=new Sn,i=new bo({color:`#9aa1a8`,metalness:.6,roughness:.45});for(let e of[-1,1]){let t=new Y(new Ri(.28,.32,9,8),i);t.position.set(e*17/2,4.5,0),r.add(t)}let a=new Y(new Fi(17,.5,.5),i);a.position.y=8.6,r.add(a);let o=new bo({color:`#6b7178`}),s=new ni({map:id(t,{w:1100,h:340}),toneMapped:!1}),c=new Y(new Fi(11,3.4,.2),[o,o,o,o,s,o]);c.position.set(0,8.5,.4);let l=new ni({map:id([n],{w:360,h:100,bg:`#f7f9f4`,fg:`#0b6b3a`,border:!1}),toneMapped:!1}),u=new Y(new Fi(3.6,1,.2),[o,o,o,o,l,o]);return u.position.set(11/2-2,10.7,.45),r.add(c,u),r.traverse(e=>{e.isMesh&&(e.castShadow=!0)}),r.position.copy(e.p),r.rotation.y=e.heading+Math.PI,r}var Q=e=>new bo({roughness:.8,...e}),$=(e,t,n,r,i=0,a=0,o=0)=>{let s=new Y(new Fi(e,t,n),r);return s.position.set(i,a+t/2,o),s},yd=(e,t,n,r,i=0,a=0,o=0,s=16)=>{let c=new Y(new Ri(e,t,n,s),r);return c.position.set(i,a+n/2,o),c},bd=(e,t,n)=>{let r=e.clone();return r.needsUpdate=!0,r.repeat.set(t,n),r},xd=(e,t,n,r)=>new ni({map:id(e,{w:Math.round(t*90),h:Math.round(n*90),...r}),toneMapped:!1});function Sd(e,t,n,r={}){let i=Q({color:`#5b6168`});return new Y(new Fi(t,n,.25),[i,i,i,i,xd(e,t,n,r),i])}function Cd(e,t,n,r){let i=new to(new _a([new G(-e/2,0),new G(e/2,0),new G(0,t)]),{depth:n,bevelEnabled:!1});return i.translate(0,0,-n/2),new Y(i,r)}function wd(e,t,n,r,i){let a=new Sn;for(let i=0;i<e;i++){let o=yd(.55,.65,n,r,-t/2+t/(e-1)*i,1.2,0,12);a.add(o)}a.add($(t+2.4,1.2,4,i,0,0,-1)),a.add($(t+2.4,1.1,4,i,0,n+1.2,-1));let o=Cd(t+2.6,3.2,4.2,i);return o.position.set(0,n+2.3,-1),a.add(o),a}function Td(e,t){let n=new Sn;switch(e){case`campus`:{let e=Q({map:bd(td(),4,2),roughness:.95}),t=Q({map:bd(ed({wall:`#d6c9ad`,glass:`#39424c`,cols:3,rows:2,frame:`#b8aa8c`}),6,2)}),r=Q({color:`#4b4f57`,roughness:.7}),i=e=>{n.add($(16,11,12,t,e,0,0));let i=Cd(16.4,5,12.4,r);i.position.set(e,11,0),n.add(i)};i(-13),i(13),n.add($(10,14,13,e,0,0,.5)),n.add($(7,16,7,e,0,14,1));for(let[t,i]of[[-3.5,-2.5],[3.5,-2.5],[-3.5,4.5],[3.5,4.5]]){n.add(yd(.9,.9,20,e,t,12,i,10));let a=new Y(new zi(1.2,3.5,10),r);a.position.set(t,33.7,i),n.add(a)}let a=new Y(new zi(4.6,10,4),r);a.position.set(0,35,1),a.rotation.y=Math.PI/4,n.add(a);let o=new Y(new Li(1.6,24),Q({color:`#f3efe4`}));o.position.set(0,25,4.55),n.add(o);let s=Cd(4,2.4,1,e);s.position.set(0,4.2,7.2),n.add(s,$(3,4.2,.4,Q({color:`#3b2a1c`}),0,0,7.1));let c=new Y(new oo(50,26),Q({color:`#5d9142`}));c.rotation.x=-Math.PI/2,c.position.set(0,.03,19),n.add(c);let l=new Y(new oo(4,26),Q({color:`#cdc6b6`}));l.rotation.x=-Math.PI/2,l.position.set(0,.05,19),n.add(l);let u=[];for(let e=0;e<=10;e++)u.push(new G(16+e*1.6,e*1.3));u.push(new G(33,13.3),new G(33,0));let d=new Y(new ao(u,48),Q({color:`#512888`,side:2,roughness:.7}));d.scale.set(1.25,1,.85),d.position.set(-36,0,-46),n.add(d);let f=new Y(new oo(34,22),Q({color:`#3f8a3a`}));f.rotation.x=-Math.PI/2,f.position.set(-36,.06,-46),n.add(f);for(let e=-3;e<=3;e++){let t=new Y(new oo(.25,22),Q({color:`#f5f5f0`}));t.rotation.x=-Math.PI/2,t.position.set(-36+e*4.5,.07,-46),n.add(t)}let p=Sd([`K-State`],10,3,{bg:`#512888`});p.position.set(-36,18,-70),n.add(p);break}case`press`:{let e=Q({map:bd(nd(),4,3)});n.add($(26,10,14,e)),n.add($(26.6,1,14.6,Q({color:`#d8d0c0`}),0,10));let t=Q({map:bd(ed({wall:`#8e4a36`,glass:`#2d3640`,cols:6,rows:2,frame:`#e9e0cf`}),1,1)}),r=new Y(new oo(25.6,9),t);r.position.set(0,5,7.02),n.add(r);let i=Sd([`The Collegian`,`Kedzie Hall`],10,2.6);i.position.set(0,12.8,7.2),n.add(i);let a=Q({color:`#e8e4da`});for(let e=0;e<6;e++)n.add($(1.4,.6,1,a,9+e%3*1.5,Math.floor(e/3)*.6,9));break}case`office`:{let e=Q({map:bd(ed({wall:`#2f3d49`,glass:`#6c8fac`,cols:6,rows:3,glassy:!0}),3,1),metalness:.6,roughness:.2});n.add($(28,13,16,e)),n.add($(29,.8,17,Q({color:`#d7dbde`}),0,13)),n.add($(8,4,4,Q({color:`#cfd4d8`}),0,0,9));let t=Sd([`Softek`],7,1.8,{bg:`#1f3b57`});t.position.set(0,14.8,8.2),n.add(t);let r=new Y(new oo(30,12),Q({color:`#4a4c50`}));r.rotation.x=-Math.PI/2,r.position.set(0,.04,17),n.add(r);break}case`cerner`:{let e=Q({map:bd(ed({wall:`#2a4a66`,glass:`#7fa9c9`,cols:6,rows:10,glassy:!0}),2,3),metalness:.7,roughness:.15});n.add($(16,58,16,e,-12,0,-4)),n.add($(14,44,14,e,12,0,-2)),n.add($(10,3,5,Q({color:`#c9d2d9`,metalness:.5}),0,22,-3)),n.add($(40,6,20,Q({map:bd(ed({wall:`#cfd6db`,glass:`#4f6f8a`,cols:8,rows:1}),2,1)}),0,0,6));let t=Sd([`Cerner`],9,2.2,{bg:`#0f5f95`});t.position.set(0,7.5,16.2),n.add(t);let r=Q({map:bd(td(`#d9d2c0`),1,6)});n.add($(24,3,12,r,34,0,-40),yd(3.2,3.8,50,r,34,3,-40,12));let i=yd(1.8,2.6,5,Q({color:`#f2c14e`,emissive:`#e07b2a`,emissiveIntensity:.6}),34,53,-40,12);n.add(i);break}case`rxss`:{let e=Q({map:bd(ed({wall:`#8a949c`,glass:`#28394a`,cols:5,rows:8,frame:`#b9c1c7`}),2,3),metalness:.2});n.add($(22,34,16,e,-6,0,-6)),n.add($(22.6,1.2,16.6,Q({color:`#c9cfd4`}),-6,34,-6));let r=Sd([`Rx Savings Solutions`],12,2,{bg:`#006f86`});r.position.set(-6,30,2.2),n.add(r);let i=Sd([`McKesson`],8,1.8,{bg:`#1b4f9c`});i.position.set(-6,26.5,2.2),n.add(i),n.add($(6,2,6,Q({color:`#d8d4cc`}),14,0,8));let a=new Sn,o=new Y(new Ii(2.1,3.4,8,20),Q({color:`#f7f9f4`,roughness:.3})),s=new Ii(2.14,3.4,8,20,1),c=s.attributes.position,l=[];for(let e=0;e<s.index.count;e+=3){let t=[0,1,2].map(t=>c.getY(s.index.getX(e+t)));Math.min(...t)>=-.01&&l.push(s.index.getX(e),s.index.getX(e+1),s.index.getX(e+2))}s.setIndex(l);let u=new Y(s,Q({color:`#12a08f`,roughness:.3}));a.add(o,u),a.position.set(14,7.5,8),a.rotation.z=.9,n.add(a),t.push(e=>{a.rotation.y=e*.5});break}case`bess`:{let e=new Y(new oo(56,38),Q({color:`#a9a69c`}));e.rotation.x=-Math.PI/2,e.position.set(0,.04,0),n.add(e);let r=Q({map:bd(ed({wall:`#eef0ee`,glass:`#c8ccc9`,cols:8,rows:1,frame:`#d7dad7`}),1,1)});for(let e=0;e<3;e++)for(let t=0;t<5;t++)n.add($(8,3,2.6,r,-20+t*10,0,-12+e*7));let i=Q({color:`#7d8a80`,metalness:.4});n.add($(6,4,5,i,22,0,10));for(let e=0;e<3;e++)n.add(yd(.3,.3,3,Q({color:`#b5693a`}),20.5+e*1.5,4,10,8));let a=Q({color:`#9aa0a3`,metalness:.6,transparent:!0,opacity:.55});n.add($(58,2.4,.1,a,0,0,19),$(58,2.4,.1,a,0,0,-19));let o=Sd([`Fluxpilot`,`Battery storage, sized in minutes`],11,2.8,{bg:`#0d4f6c`});o.position.set(-16,3,21),n.add(o);let s=Q({color:`#f1f3f4`,roughness:.5});[[-18,-42],[4,-48],[26,-40]].forEach(([e,r],i)=>{n.add(yd(.9,1.6,42,s,e,0,r,12));let a=new Sn;a.position.set(e,42,r+1.6),a.add(new Y(new so(1.1,12,8),s));for(let e=0;e<3;e++){let t=new Y(new Fi(1.1,20,.3).translate(0,10,0),s);t.rotation.z=e/3*Math.PI*2,a.add(t)}n.add($(2,1.8,4,s,e,41.1,r-.4),a),t.push(e=>{a.rotation.z=e*.8+i})});let c=Q({color:`#1f3550`,metalness:.6,roughness:.25});for(let e=0;e<4;e++){let t=$(40,.2,3,c,0,1.4,26+e*4.2);t.rotation.x=-.35,n.add(t)}break}case`factory`:{let e=Q({map:bd(nd(`#7f4431`),6,2)});n.add($(36,9,20,e));let r=Q({color:`#6c6f73`,metalness:.4});for(let e=0;e<6;e++){let t=Cd(6,3.5,20,r);t.position.set(-15+e*6,9,0),t.scale.x=1,n.add(t),n.add($(.2,3.3,19.6,Q({color:`#9fc2da`,metalness:.3,roughness:.2}),-12.1+e*6,9,0))}let i=Q({color:`#7a6c62`});n.add(yd(1.2,1.6,22,i,13,0,-7,12),yd(1,1.4,18,i,17,0,-4,12));let a=[];for(let e=0;e<6;e++){let e=new Y(new io(1.4,1),new bo({color:`#e7e7e7`,transparent:!0,depthWrite:!1}));n.add(e),a.push(e)}t.push(e=>a.forEach((t,n)=>{let r=(e*.25+n/a.length)%1;t.position.set(13+r*3,22+r*12,-7),t.scale.setScalar(.7+r*2.2),t.material.opacity=.85*(1-r)}));for(let e=0;e<3;e++)n.add($(4,5,.3,Q({color:`#5b6066`,metalness:.5}),-12+e*6,0,10.1));let o=new Y(new oo(10,5.6),new ni({map:sd([`Line 3 training`,`Scan the QR code to watch`]),toneMapped:!1}));o.position.set(8,6.5,10.2),n.add(o);let s=Sd([`Annovox AI`],9,2,{bg:`#28324a`});s.position.set(-8,10.5,10.3),n.add(s);let c=new Sn;c.add($(3,3.4,9,Q({color:`#e9ebec`}),0,.8,0),$(3,2.8,2.6,Q({color:`#c8322b`}),0,.8,6)),c.position.set(-6,0,16),n.add(c);break}case`capitol`:{let e=Q({map:bd(td(`#e8e3d6`),6,2),roughness:.9}),t=Q({color:`#ece7da`,roughness:.85});n.add($(64,3,22,t,0,0,0)),n.add($(60,12,18,e,0,3,0)),n.add($(61,1.4,19,t,0,15,0));let r=wd(8,20,9,t,t);r.position.set(0,3,10.5),n.add(r);for(let e of[-22,22]){let r=wd(6,11,9,t,t);r.position.set(e,3,10.5),n.add(r)}n.add(yd(9,9.5,5,t,0,16.4,0,32));for(let e=0;e<20;e++){let r=e/20*Math.PI*2;n.add(yd(.45,.5,8,t,Math.cos(r)*8.2,21.4,Math.sin(r)*8.2,10))}n.add(yd(7.9,7.9,8,e,0,21.4,0,32)),n.add(yd(8.8,8.8,1.2,t,0,29.4,0,32));let i=new Y(new so(8,32,16,0,Math.PI*2,0,Math.PI/2),t);i.position.set(0,30.6,0),i.scale.y=1.15,n.add(i),n.add(yd(1.6,1.8,4,t,0,39.6,0,12));let a=new Y(new so(1.8,12,8,0,Math.PI*2,0,Math.PI/2),Q({color:`#c9a445`,metalness:.7,roughness:.3}));a.position.set(0,43.6,0),n.add(a);for(let e=0;e<6;e++)n.add($(24-e*2,.5,1.4,t,0,e*.5,13+e*1.3-6));let o=new Sn;o.add($(16,1.2,8,Q({color:`#1d1f24`})));let s=new Y(new oo(14,7.8),new ni({map:sd([`Demo Day`,`OpenAI × GitLab Foundation, San Francisco`],`#0e0f12`),toneMapped:!1}));s.position.set(0,6,-3.6),o.add(s),o.add($(15,.5,.5,Q({color:`#2a2c31`}),0,10,-3.6)),o.add(yd(.3,.4,1.3,Q({color:`#3a3d44`}),2,1.2,1,8)),o.position.set(44,0,18),o.rotation.y=-.5,n.add(o);break}case`billboards`:{let e=[[`Meta Ads`,`Published with Addi`,`#1b64d8`],[`TikTok Ads`,`Published with Addi`,`#15121a`],[`Google Ads`,`Published with Addi`,`#1a8f47`],[`YouTube Ads`,`Published with Addi`,`#c5221f`],[`Spotify Ads`,`Published with Addi`,`#1a9e52`]],t=Q({color:`#7b8187`,metalness:.6});e.forEach(([e,r,i],a)=>{let o=new Sn;o.add(yd(.5,.6,12,t,0,0,0,10)),o.add($(15,6.4,.6,Q({color:`#2d3136`}),0,12,0));let s=new Y(new oo(14.4,5.8),new ni({map:od(e,r,i),toneMapped:!1}));s.position.set(0,15.2,.31),o.add(s),o.add($(15,.3,1.2,t,0,11.8,.6)),o.position.set(-44+a*22,0,a%2*-16),o.rotation.y=(a-2)*-.12,n.add(o)});break}case`imaging`:{let e=Q({color:`#f1f3f2`,roughness:.6}),r=Q({color:`#9cc4d6`,metalness:.2,roughness:.05,transparent:!0,opacity:.35});n.add($(30,9,18,Q({map:bd(ed({wall:`#e9ecea`,glass:`#7fa6b8`,cols:5,rows:2}),2,1)}),-8,0,-2)),n.add($(16,8,12,r,15,0,1)),n.add($(16.6,.8,12.6,e,15,8,1)),n.add($(16,.3,12,Q({color:`#d7dcdb`}),15,.05,1));let i=new Y(new co(2.6,1.1,16,40),e);i.position.set(15,3.6,1),n.add(i);let a=new Y(new co(1.55,.08,8,40),Q({color:`#2fa3d6`,emissive:`#2fa3d6`,emissiveIntensity:.6}));a.position.set(15,3.6,1.2),n.add(a);let o=$(1.4,.4,5,Q({color:`#2fa3d6`}),15,2.6,3);n.add(o,$(1.2,2.6,1.6,Q({color:`#c9ced2`}),15,0,4)),t.push(e=>{o.position.z=2.6+Math.sin(e*.7)*1.6});let s=Sd([`OneImaging`],10,2.2,{bg:`#1c6fb5`});s.position.set(-8,9.8,7.2),n.add(s);break}case`chicago`:{let e=Q({map:bd(ed({wall:`#1c1f24`,glass:`#3b4652`,cols:4,rows:16,glassy:!0}),1,4),metalness:.6,roughness:.3});[[108,70,70],[108,108,90],[90,90,50]].forEach((t,r)=>t.forEach((t,i)=>n.add($(7,t,7,e,-40+i*7,0,-70+r*7)))),n.add(yd(.3,.4,20,Q({color:`#d0d4d8`}),-37,108,-70,6),yd(.3,.4,16,Q({color:`#d0d4d8`}),-30,108,-63,6));let r=new Y(new Ri(6.5,11,96,4,1),e);r.rotation.y=Math.PI/4,r.position.set(12,48,-90),n.add(r),n.add(yd(.3,.4,18,Q({color:`#d0d4d8`}),10,96,-90,6),yd(.3,.4,18,Q({color:`#d0d4d8`}),14,96,-90,6));let i=Q({color:`#d8d6d0`});for(let e of[34,44]){n.add(yd(3.8,3.8,52,Q({color:`#8f8c86`}),e,0,-46,20));for(let t=16;t<52;t+=2.2){let r=new Y(new co(4.4,.55,6,18),i);r.rotation.x=Math.PI/2,r.position.set(e,t,-46),n.add(r)}}let a=new Y(new oo(40,30),Q({color:`#c9c5bc`}));a.rotation.x=-Math.PI/2,a.position.set(-4,.04,6),n.add(a);let o=new Y(new so(4,48,24),Q({color:`#ffffff`,metalness:1,roughness:.04}));o.scale.set(2,1,1.3),o.position.set(-4,3.4,6),n.add(o);let s=new Y(new oo(600,400),Q({color:`#2d6f8f`,metalness:.3,roughness:.15}));s.rotation.x=-Math.PI/2,s.position.set(0,.2,-330),n.add(s);let c=Q({color:`#e0b43c`,metalness:.9,roughness:.25});[-14,14].forEach((e,r)=>{n.add($(3,2,3,Q({color:`#2f3237`}),e,0,14)),n.add(yd(.4,.8,1.6,c,e,2,14,12));let i=yd(1.6,.6,2.4,c,e,3.6,14,18);n.add(i),t.push(e=>{i.rotation.y=e*(r?-1:1)})});break}}return n.traverse(e=>{e.isMesh&&!e.material.transparent&&(e.castShadow=!0,e.receiveShadow=!0)}),n}function Ed(){let e=new Sn,t=new xo({color:`#a3121c`,metalness:.15,roughness:.45,clearcoat:.25,clearcoatRoughness:.3,envMapIntensity:.5}),n=new bo({color:`#16181b`,roughness:.6}),r=new xo({color:`#0f1a24`,metalness:.2,roughness:.05,transmission:0,clearcoat:1}),i=new bo({color:`#d7dade`,metalness:1,roughness:.18}),a=(e,t,n,r=.08)=>{let i=new to(new _a(e.map(([e,t])=>new G(e,t))),{depth:t-r*2,bevelEnabled:!0,bevelSize:r,bevelThickness:r,bevelSegments:3,curveSegments:8});return i.rotateY(-Math.PI/2),i.translate((t-r*2)/2,0,0),new Y(i,n)},o=a([[-2.3,.38],[2.28,.38],[2.36,.62],[2.3,.86],[1.95,.98],[.95,1.06],[-1.75,1.08],[-2.28,1.02],[-2.36,.72]],1.9,t),s=a([[.95,1.04],[.22,1.56],[-.95,1.58],[-1.72,1.06]],1.72,r,.06),c=a([[.2,1.555],[-.92,1.575],[-.95,1.63],[.14,1.61]],1.7599999999999998,t,.05);e.add(o,s,c);let l=e=>{let t=new Y(new Fi(1.94,.22,.2),n);return t.position.set(0,.45,e),t};e.add(l(2.34),l(-2.36));let u=new Y(new Fi(.9,.18,.05),n);u.position.set(0,.7,2.37),e.add(u);let d=new bo({color:`#fdfaf0`,emissive:`#fff4cc`,emissiveIntensity:1.4}),f=new bo({color:`#6a0e0b`,emissive:`#c0180f`,emissiveIntensity:.7});for(let t of[-.66,.66]){let n=new Y(new Fi(.46,.14,.06),d);n.position.set(t,.8,2.33),e.add(n);let r=new Y(new Fi(.5,.14,.06),f);r.position.set(t,.86,-2.36),e.add(r)}for(let n of[-1,1]){let r=new Y(new Fi(.2,.12,.26),t);r.position.set(n*1.03,1.12,.85),e.add(r)}let p=new Y(new Fi(.52,.12,.02),new bo({color:`#f2f0e8`}));p.position.set(0,.62,-2.47),e.add(p);let m=new Ri(.4,.4,.3,24).rotateZ(Math.PI/2),h=new Ri(.26,.26,.32,10).rotateZ(Math.PI/2),g=new bo({color:`#141414`,roughness:.95}),_=[],v=[];for(let[t,n]of[[-.86,1.45],[.86,1.45],[-.86,-1.42],[.86,-1.42]]){let r=new Sn;r.position.set(t,.4,n);let a=new Y(m,g),o=new Y(h,i);for(let e=0;e<5;e++){let t=new Y(new Fi(.33,.05,.06),i);t.rotation.x=e/5*Math.PI*2,t.position.x=0,a.add(t)}a.add(o),r.add(a),e.add(r),_.push(a),n>0&&v.push(r)}return e.traverse(e=>{e.isMesh&&(e.castShadow=!0)}),{group:e,spin:e=>_.forEach(t=>{t.rotation.x+=e/.4}),steer:e=>v.forEach(t=>{t.rotation.y+=(e*.5-t.rotation.y)*.25}),brake:e=>{f.emissiveIntensity=e?2.2:.7},body:e}}var Dd=26,Od=new bo({color:`#f26a1b`,roughness:.55}),kd=new bo({color:`#f5f5f0`,roughness:.4,emissive:`#ffffff`,emissiveIntensity:.08}),Ad=new bo({color:`#1a1a1a`,roughness:.8}),jd=new Ri(.07,.34,1.05,16,1,!0),Md=new Ri(.16,.22,.14,16,1,!0),Nd=new Fi(.85,.07,.85);function Pd(){let e=new Sn,t=new Y(jd,Od);t.position.y=.6;let n=new Y(Md,kd);n.position.y=.72;let r=new Y(new Ri(.24,.29,.12,16,1,!0),kd);r.position.y=.46;let i=new Y(Nd,Ad);return i.position.y=.035,e.add(t,n,r,i),e.traverse(e=>{e.isMesh&&(e.castShadow=!0)}),e}var Fd=new bo({map:ad(),roughness:.5});function Id(e){let t=new Sn,n=new bo({color:`#e8e8e2`,roughness:.6});for(let e of[-2.1,2.1]){let r=new Y(new Fi(.14,1.9,.14),n);r.position.set(e,.95,0),t.add(r);let i=new Y(new Fi(.2,.12,1.3),Ad);i.position.set(e,.06,0),t.add(i)}for(let e of[.55,1.1,1.65]){let n=new Y(new Fi(4.8,.3,.06),Fd);n.position.set(0,e,.08),t.add(n)}let r=new bo({color:`#d45a14`}),i=new ni({map:id([e],{w:600,h:150,bg:`#f26a1b`,fg:`#141414`,border:!0}),toneMapped:!1}),a=new Y(new Fi(4.2,1.05,.06),[r,r,r,r,i,r]);a.position.set(0,2.45,.1),t.add(a);let o=new bo({color:`#ffb300`,emissive:`#ff9c00`,emissiveIntensity:1});for(let e of[-2.1,2.1]){let n=new Y(new Ri(.13,.13,.2,10),o);n.position.set(e,2,0),t.add(n)}return t.userData.lamp=o,t.traverse(e=>{e.isMesh&&(e.castShadow=!0)}),t}function Ld(e){let t=new Sn,n=new bo({color:`#512888`,roughness:.6});for(let e of[-15/2,15/2]){let r=new Y(new Fi(.5,6.4,.5),n);r.position.set(e,3.2,0),t.add(r)}let r=new ni({map:id(e.honors?[e.term,`Semester honors`]:[e.term],{w:900,h:150,bg:`#512888`,fg:`#ffffff`}),toneMapped:!1}),i=new Y(new Fi(15,1.5,.15),[n,n,n,n,r,n]);return i.position.y=6.2,t.add(i),t.traverse(e=>{e.isMesh&&(e.castShadow=!0)}),t}function Rd(e){let t=new Yr(new Fr({map:id([e],{w:256,h:72,bg:`rgba(20,20,24,0.82)`,fg:`#ffffff`,border:!1}),depthWrite:!1}));return t.scale.set(2.2,.62,1),t.position.y=1.8,t}function zd(e,t,n){let r=[];n.forEach((n,i)=>{n.items.forEach(n=>{if(n.type===`gate`){let a=t.at(n.s),o=Ld(n.sem);o.position.copy(a.p),o.rotation.y=a.heading+Math.PI,e.add(o);let s=n.sem.courses.length,c=t.at(n.s+8);n.sem.courses.forEach(([t,a],o)=>{let l=Pd(),u=(o-(s-1)/2)*Math.min(1.7,9/Math.max(1,s-1));l.position.copy(c.p).addScaledVector(c.n,u),l.add(Rd(t)),e.add(l),r.push({kind:`course`,mesh:l,s:n.s+8,lateral:u,radius:.7,section:i,title:t,text:`${t}: ${a}`,term:n.sem.term})})}else{let a=t.at(n.s),o=Id(n.label),s=n.index%2?-2.3:2.3;o.position.copy(a.p).addScaledVector(a.n,s),o.rotation.y=a.heading+Math.PI,e.add(o),r.push({kind:`feat`,mesh:o,s:n.s,lateral:s,radius:2.6,section:i,title:n.label,text:n.text})}})});let i=[],a=new K;function o(e,t,n){e.hit=!0,e.t=0;let r=a.set(Math.sin(t.heading),0,Math.cos(t.heading)),o=Math.max(Math.abs(t.speed),12),s=(Math.random()-.5)*2;e.vel=new K(r.x*o*(n?.9:.35),(n?7:4)+Math.random()*3,r.z*o*(n?.9:.35)),e.vel.x+=-r.z*s*4,e.vel.z+=r.x*s*4,e.ang=new K((Math.random()-.5)*10,(Math.random()-.5)*6,(Math.random()-.5)*10),e.mesh.children.filter(e=>e.isSprite).forEach(e=>e.removeFromParent()),i.push(e)}function s(e,t,n,a){for(let e of r){if(e.hit||Math.abs(e.s-t.s)>6)continue;let n=e.mesh.position.x-t.x,r=e.mesh.position.z-t.z,i=Math.hypot(n,r)<e.radius+1.2,s=t.s>e.s+.5&&t.prevS<=e.s+.5&&Math.abs(t.lateral)<8.5;(i||s)&&(o(e,t,i),a(e,i))}for(let t=i.length-1;t>=0;t--){let n=i[t];n.t+=e;let r=n.mesh;n.vel.y-=Dd*e,r.position.addScaledVector(n.vel,e),r.rotation.x+=n.ang.x*e,r.rotation.y+=n.ang.y*e,r.rotation.z+=n.ang.z*e,r.position.y<.1&&(r.position.y=.1,n.vel.y*=-.3,n.vel.x*=.7,n.vel.z*=.7,n.ang.multiplyScalar(.6)),n.t>3.5&&(r.position.y-=e*1.5,n.t>5&&(r.removeFromParent(),i.splice(t,1)))}let s=Math.sin(n*8)>0;for(let e of r)!e.hit&&e.kind===`feat`&&(e.mesh.userData.lamp.emissiveIntensity=s?2.2:.2)}return{list:r,update:s}}function Bd(){let e,t,n,r,i=!1;function a(){e=new AudioContext,t=e.createOscillator(),t.type=`sawtooth`;let i=e.createOscillator();i.type=`square`,r=e.createBiquadFilter(),r.type=`lowpass`,r.frequency.value=400,n=e.createGain(),n.gain.value=0;let a=e.createGain();a.gain.value=.4,t.connect(r),i.connect(a).connect(r),r.connect(n).connect(e.destination),t.start(),i.start(),t.sub=i}return{get on(){return i},toggle(){return e||a(),i=!i,i?e.resume():n.gain.setTargetAtTime(0,e.currentTime,.05),i},engine(a){if(!i)return;let o=38+Math.abs(a)*3.2;t.frequency.setTargetAtTime(o,e.currentTime,.05),t.sub.frequency.setTargetAtTime(o/2,e.currentTime,.05),r.frequency.setTargetAtTime(300+Math.abs(a)*25,e.currentTime,.05),n.gain.setTargetAtTime(.05+Math.min(Math.abs(a),40)*.0025,e.currentTime,.1)},hit(t=1){if(!i)return;let n=e.createBuffer(1,e.sampleRate*.25,e.sampleRate),r=n.getChannelData(0);for(let e=0;e<r.length;e++)r[e]=(Math.random()*2-1)*(1-e/r.length)**3;let a=e.createBufferSource();a.buffer=n;let o=e.createBiquadFilter();o.type=`lowpass`,o.frequency.value=900+t*600;let s=e.createGain();s.gain.value=.25*t,a.connect(o).connect(s).connect(e.destination),a.start()}}}var Vd=matchMedia(`(prefers-reduced-motion: reduce)`).matches,Hd=e=>document.querySelector(e),Ud=(e,t={},...n)=>{let r=Object.assign(document.createElement(e),t);return r.append(...n),r};Gd(),Hd(`#open-list`).addEventListener(`click`,()=>Hd(`#list`).showModal()),Hd(`#close-list`).addEventListener(`click`,()=>Hd(`#list`).close()),(()=>{try{return document.createElement(`canvas`).getContext(`webgl2`)}catch{return null}})()?document.fonts.load(`800 64px Overpass`).finally(()=>requestAnimationFrame(Wd)):(document.body.classList.add(`no-webgl`),Hd(`#loading`).hidden=!0,Hd(`#list`).showModal());function Wd(){let{plan:e,length:t}=md(Ku,Gu),n=new Hu({canvas:Hd(`#scene`),antialias:!0,powerPreference:`high-performance`});n.setPixelRatio(Math.min(devicePixelRatio,1.75)),n.toneMapping=4,n.toneMappingExposure=.42,n.shadowMap.enabled=!0,n.shadowMap.type=1;let r=new jn,i=new ns(55,1,.5,2600),a=new Uu;a.scale.setScalar(1e4);let o=new K().setFromSphericalCoords(1,Ct.degToRad(62),Ct.degToRad(210));a.material.uniforms.turbidity.value=4,a.material.uniforms.rayleigh.value=2.2,a.material.uniforms.mieCoefficient.value=.004,a.material.uniforms.mieDirectionalG.value=.85,a.material.uniforms.sunPosition.value.copy(o),r.add(a);let s=new Ys(n),c=new jn,l=a.clone();c.add(l),r.environment=s.fromScene(c,.02).texture,r.environmentIntensity=.45,r.fog=new An(`#c9d9e4`,260,1500);let u=new as(`#fff1dc`,2.6);u.castShadow=!0,u.shadow.mapSize.set(2048,2048),u.shadow.bias=-4e-4,u.shadow.normalBias=.6,Object.assign(u.shadow.camera,{left:-90,right:90,top:90,bottom:-90,near:1,far:500}),r.add(u,u.target),r.add(new Wo(`#cfe4ff`,`#6b5a3a`,.6));let d=hd(t);_d(r,d,e);let f=[],p=e.map(e=>{let t=d.at(e.landmarkS),n=Td(e.landmark,f),i=t.p.clone().addScaledVector(t.n,e.side*50);n.position.copy(i);let a=t.n.clone().multiplyScalar(-e.side);return n.rotation.y=Math.atan2(a.x,a.z),r.add(n),{sec:e,pos:i,s:e.landmarkS}}),m=zd(r,d,e),h=Ed();r.add(h.group);let g=Bd(),_=e.find(e=>e.id===location.hash.slice(1)),v=d.at(_?_.landmarkS-45:20);d.reset(v.i),_&&m.list.filter(e=>e.s<v.s).forEach(e=>{e.hit=!0,e.skipped=!0,e.mesh.removeFromParent()});let y=m.list.filter(e=>!e.skipped),b={course:y.filter(e=>e.kind===`course`).length,feat:y.filter(e=>e.kind===`feat`).length},x={x:v.p.x,z:v.p.z,heading:v.heading,speed:0,steer:0,s:v.s,prevS:v.s,lateral:0,auto:null,section:-1,done:{course:0,feat:0},shake:0,finished:!1},S=new Set,C=[`w`,`a`,`s`,`d`,`arrowup`,`arrowdown`,`arrowleft`,`arrowright`];addEventListener(`keydown`,e=>{if(e.target.closest?.(`dialog`))return;let t=e.key.toLowerCase();[...C,` `].includes(t)&&e.preventDefault(),C.includes(t)&&(S.add(t),x.auto=null,x.autoS=null),t===`n`&&te(),t===`m`&&T(),t===`j`&&E()}),addEventListener(`keyup`,e=>S.delete(e.key.toLowerCase())),addEventListener(`blur`,()=>S.clear()),document.querySelectorAll(`[data-key]`).forEach(e=>{let t=e.dataset.key,n=n=>{n.preventDefault(),S.add(t),x.auto=null,x.autoS=null,e.classList.add(`down`)},r=()=>{S.delete(t),e.classList.remove(`down`)};e.addEventListener(`pointerdown`,n),[`pointerup`,`pointerleave`,`pointercancel`].forEach(t=>e.addEventListener(t,r))});let w=Hd(`#stops`);e.forEach((e,t)=>{let n=Ud(`button`,{className:`stop`,textContent:e.years===`Now`?`Now`:e.years.slice(0,4),title:e.company});n.setAttribute(`aria-label`,`Drive to ${e.company}`),n.addEventListener(`click`,()=>ne(e.landmarkS-40)),w.append(n)}),Hd(`#next`).addEventListener(`click`,te),Hd(`#sound`).addEventListener(`click`,T),Hd(`#journal-btn`).addEventListener(`click`,E),Hd(`#journal-close`).addEventListener(`click`,E),Hd(`#finish-close`).addEventListener(`click`,()=>{Hd(`#finish`).hidden=!0});function T(){let e=g.toggle();Hd(`#sound`).textContent=e?`Sound on`:`Sound off`,Hd(`#sound`).setAttribute(`aria-pressed`,e)}function E(){let e=Hd(`#journal`);e.hidden=!e.hidden,Hd(`#journal-btn`).setAttribute(`aria-expanded`,!e.hidden)}let D=Hd(`#journal-body`),O=new Map;e.forEach((e,t)=>{let n=m.list.filter(e=>e.section===t),r=Ud(`ul`);n.forEach(e=>{let t=Ud(`li`,{textContent:(e.kind,e.text)});e.kind===`course`&&t.classList.add(`course`),O.set(e,t),r.append(t)}),D.append(Ud(`section`,{},Ud(`h3`,{textContent:e.company}),Ud(`p`,{className:`j-meta`,textContent:`${e.title}, ${e.years}`}),r))});function k(){Hd(`#count-feat`).textContent=`${x.done.feat} / ${b.feat}`,Hd(`#count-course`).textContent=`${x.done.course} / ${b.course}`}k();let A,j=Hd(`#feed`);function M(e,t){let n=Ud(`div`,{className:`toast ${e.kind}`},Ud(`strong`,{textContent:e.kind===`course`?`${e.term}: ${e.title}`:e.title}),Ud(`span`,{textContent:e.kind===`course`?e.text.split(`: `)[1]:e.text}));for(j.prepend(n);j.children.length>3;)j.lastChild.remove();clearTimeout(A),setTimeout(()=>n.classList.add(`out`),5200),setTimeout(()=>n.remove(),5800),t&&(x.shake=.35)}function N(e,t){x.done[e.kind]++,O.get(e)?.classList.add(`done`),k(),M(e,t),g.hit(t?1:.4),t&&(x.speed*=e.kind===`feat`?.82:.95)}function P(t){let n=e[t],r=Hd(`#card`);r.querySelector(`.card-years`).textContent=n.years,r.querySelector(`h2`).textContent=n.company,r.querySelector(`.card-role`).textContent=n.title,r.querySelector(`.card-place`).textContent=n.place,r.querySelector(`.card-blurb`).textContent=n.blurb,r.hidden=!1,r.classList.remove(`in`),r.offsetWidth,r.classList.add(`in`),clearTimeout(P.t),innerWidth<760&&(P.t=setTimeout(()=>{r.hidden=!0},6e3)),document.querySelectorAll(`.stop`).forEach((e,n)=>{e.classList.toggle(`here`,n===t),n<=t&&e.classList.add(`seen`)})}let F=Hd(`#minimap`),I=F.getContext(`2d`),ee=new Kn().setFromPoints(d.samples.map(e=>e.p));function L(){let e=Math.min(devicePixelRatio,2),t=F.clientWidth*e,n=F.clientHeight*e;F.width!==t&&(F.width=t,F.height=n);let r=10*e,i=Math.min((t-r*2)/(ee.max.x-ee.min.x),(n-r*2)/(ee.max.z-ee.min.z)),a=e=>r+(e-ee.min.x)*i+(t-r*2-(ee.max.x-ee.min.x)*i)/2,o=e=>r+(e-ee.min.z)*i;I.clearRect(0,0,t,n),I.lineCap=`round`,I.lineJoin=`round`,I.lineWidth=3*e,I.strokeStyle=`rgba(255,255,255,0.35)`,I.beginPath(),d.samples.forEach((e,t)=>{t%6||(t?I.lineTo(a(e.p.x),o(e.p.z)):I.moveTo(a(e.p.x),o(e.p.z)))}),I.stroke(),I.strokeStyle=`#f2c230`,I.beginPath(),d.samples.forEach((e,t)=>{t%6||e.s>x.s||(t?I.lineTo(a(e.p.x),o(e.p.z)):I.moveTo(a(e.p.x),o(e.p.z)))}),I.stroke(),p.forEach((t,n)=>{let r=d.at(t.s);I.fillStyle=n<=x.section?`#1f9d5b`:`#f7f9f4`,I.beginPath(),I.arc(a(r.p.x),o(r.p.z),3.5*e,0,Math.PI*2),I.fill()}),I.save(),I.translate(a(x.x),o(x.z)),I.rotate(-x.heading+Math.PI),I.fillStyle=`#e8352b`,I.beginPath(),I.moveTo(0,-6*e),I.lineTo(4.5*e,5*e),I.lineTo(-4.5*e,5*e),I.fill(),I.restore()}function te(){let t=e.find(e=>e.landmarkS-40>x.s+5);ne(t?t.landmarkS-40:e[0].landmarkS-40)}function ne(e){if(e<x.s){let t=d.at(e);Object.assign(x,{x:t.p.x,z:t.p.z,heading:t.heading,speed:0,s:e,prevS:e,auto:null}),d.reset(t.i);return}x.auto={target:e},x.autoS=x.s}function re(){n.setSize(innerWidth,innerHeight,!1),i.aspect=innerWidth/innerHeight,i.fov=innerWidth<700?68:55,i.updateProjectionMatrix()}addEventListener(`resize`,re),re();let ie=new us,ae=new K(x.x,12,x.z+20),R=new K,oe=new K;i.position.copy(ae),Hd(`#loading`).classList.add(`gone`),setTimeout(()=>{Hd(`#loading`).hidden=!0},600),n.setAnimationLoop(()=>{ie.update();let e=Math.min(ie.getDelta(),.05),t=ie.getElapsed();se(e),m.update(e,x,t,N),Vd||f.forEach(e=>e(t)),h.group.position.set(x.x,0,x.z),h.group.rotation.y=x.heading,h.group.rotation.z=-x.steer*Math.min(Math.abs(x.speed)/40,1)*.05,h.spin(x.speed*e),h.steer(x.steer),h.brake(x.braking);let a=11+Math.abs(x.speed)*.12,s=x.speed<-2?-1:1,c=x.x-Math.sin(x.heading)*a*s,l=x.z-Math.cos(x.heading)*a*s;ae.lerp(new K(c,4.8+Math.abs(x.speed)*.04,l),Vd?1:1-.004**e),i.position.copy(ae),x.shake>0&&!Vd&&(i.position.x+=(Math.random()-.5)*x.shake,i.position.y+=(Math.random()-.5)*x.shake,x.shake=Math.max(0,x.shake-e)),R.set(x.x+Math.sin(x.heading)*8,1.6,x.z+Math.cos(x.heading)*8);let d=p.find(e=>x.s>e.s-110&&x.s<e.s+30),_=0;d&&(_=Math.sin(Ct.clamp((x.s-(d.s-110))/140,0,1)*Math.PI)*.5,oe.set(d.pos.x,16,d.pos.z),R.lerp(oe,_),i.position.y+=_*9),i.lookAt(R),u.position.set(x.x+o.x*200,o.y*200,x.z+o.z*200),u.target.position.set(x.x+Math.sin(x.heading)*30,0,x.z+Math.cos(x.heading)*30),g.engine(x.speed),Hd(`#speed`).textContent=Math.round(Math.abs(x.speed)*2.1),L(),n.render(r,i)});function se(t){let n=S.has(`w`)||S.has(`arrowup`),r=S.has(`s`)||S.has(`arrowdown`),i=S.has(`a`)||S.has(`arrowleft`),a=S.has(`d`)||S.has(`arrowright`);if(x.prevS=x.s,x.auto){let e=x.auto.target-(x.autoS??x.s),n=Ct.clamp(e*.8,6,34);x.speed+=(n-x.speed)*Math.min(1,t*2),x.autoS=(x.autoS??x.s)+x.speed*t;let r=Math.min(x.autoS/d.total,1),i=d.curve.getPointAt(r),a=d.curve.getTangentAt(r);x.x=i.x,x.z=i.z,x.heading=Math.atan2(a.x,a.z),x.steer=0,x.braking=!1,e<1&&(x.auto=null,x.autoS=null,x.speed=0)}else{let e=d.nearest(x),o=e.dist>7,s=o?14:42;x.braking=r&&x.speed>.5,n?x.speed+=(x.speed<0?40:20-x.speed*.25)*t:r?x.speed-=(x.speed>0?38:12)*t:x.speed*=(o?.3:.7)**t,x.speed>s&&(x.speed+=(s-x.speed)*Math.min(1,t*3)),x.speed=Math.max(x.speed,-10),Math.abs(x.speed)<.1&&!n&&!r&&(x.speed=0),x.steer+=(!!i-+!!a-x.steer)*Math.min(1,t*8);let c=Math.min(1,Math.abs(x.speed)/6)*(1-Math.min(Math.abs(x.speed),42)/110);if(x.heading+=x.steer*1.8*t*c*Math.sign(x.speed||1),x.x+=Math.sin(x.heading)*x.speed*t,x.z+=Math.cos(x.heading)*x.speed*t,e.dist>60){let t=(e.dist-60)/e.dist;x.x-=(x.x-e.sample.p.x)*t,x.z-=(x.z-e.sample.p.z)*t,x.speed*=.9}}let o=d.nearest(x);x.s=o.sample.s;let s=x.x-o.sample.p.x,c=x.z-o.sample.p.z;x.lateral=s*o.sample.n.x+c*o.sample.n.z;let l=e.findIndex(e=>x.s>e.landmarkS-60&&x.s<e.end);l!==-1&&l!==x.section&&(x.section=l,P(l)),!x.finished&&x.s>e.at(-1).landmarkS&&(x.finished=!0,Hd(`#finish-count`).textContent=`You overcame ${x.done.feat} of ${b.feat} accomplishments and passed ${x.done.course} of ${b.course} courses.`,Hd(`#finish`).hidden=!1),x.s>80&&Hd(`#hint`).classList.add(`gone`)}}function Gd(){let e=Hd(`#list-body`),t=Ud(`p`,{className:`list-contact`},Ud(`a`,{href:`mailto:${Wu.email}`,textContent:Wu.email}),` `,Ud(`a`,{href:Wu.linkedin,textContent:`LinkedIn`,rel:`me noopener`,target:`_blank`}),` `,Ud(`a`,{href:Wu.github,textContent:`GitHub`,rel:`me noopener`,target:`_blank`}));e.append(Ud(`header`,{},Ud(`h2`,{textContent:Wu.name}),Ud(`p`,{className:`list-role`,textContent:`${Wu.role}, ${Wu.location}`}),Ud(`p`,{textContent:Wu.summary}),t)),[...Ku].reverse().forEach(t=>{e.append(Ud(`section`,{},Ud(`h3`,{textContent:t.company}),Ud(`p`,{className:`list-role`,textContent:[t.title,t.years,t.place].filter(Boolean).join(`, `)}),Ud(`ul`,{},...t.obstacles.map(([,e])=>Ud(`li`,{textContent:e})))))}),e.append(Ud(`section`,{},Ud(`h3`,{textContent:`Kansas State coursework`}),...Gu.map(e=>Ud(`p`,{className:`list-courses`},Ud(`strong`,{textContent:`${e.term}${e.honors?` (semester honors)`:``}: `}),e.courses.map(([e,t])=>`${e} ${t}`).join(`, `))))),e.append(Ud(`section`,{},Ud(`h3`,{textContent:`Skills`}),Ud(`dl`,{className:`list-skills`},...qu.flatMap(([e,t])=>[Ud(`dt`,{textContent:e}),Ud(`dd`,{textContent:t})])))),Hd(`#contact`).href=`mailto:${Wu.email}`,Hd(`#linkedin`).href=Wu.linkedin}