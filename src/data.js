...
export const semesters = [
  ...
  { term: 'Summer 2015', courses: [['PHYS 213', 'Engineering Physics 1']] },
  ...
  { term: 'Fall 2017', honors: true, courses: [
  ...
  { term: 'Spring 2018', honors: true, courses: [
  ...
  { term: 'Summer 2018', courses: [['ECE 690', 'Problems in Electrical Engineering']] },
...
export const sections = [
  {
    id: 'ksu', kind: 'campus', landmark: 'campus', years: '2014–2018',
    company: 'Kansas State University', place: 'Manhattan, KS',
    title: 'B.S. Computer Engineering, minor in Computer Science',
    blurb: 'Every course is a cone at its semester gate. Drive through each gate to finish the term.',
    obstacles: [
      ['IEEE president', 'President of the IEEE student chapter (2018).'],
      ['Hack K-State', 'Won Hack K-State (2017).'],
      ['Graduated', 'Graduated December 2018 with a B.S. in Computer Engineering and a minor in Computer Science.'],
    ],
  },
  {
    id: 'collegian', landmark: 'press', years: '2015–2018',
    ...
    obstacles: [
      ['100 Macs', 'Kept a network of about 100 Mac workstations running for 65+ faculty, staff, and students.'],
      ['kstatecollegian.com', 'Redesigned and ran kstatecollegian.com, including traffic management.'],
      ['Promoted', 'Promoted to IT Support Manager in 2017.'],
      ['Hired a team', 'Interviewed, hired, and led the IT support staff.'],
      ['Tech of the Year', 'Named Tech of the Year (2017).'],
    ],
  },
  {
    id: 'softek', landmark: 'office', years: '2018',
    company: 'Softek Illuminate', place: 'Overland Park, KS',
    title: 'Software Engineering Intern',
    blurb: 'First engineering job, on the Insight application.',
    obstacles: [
  ...
  {
    id: 'cerner', landmark: 'cerner', years: '2019–2020',
    ...
    obstacles: [
      ...
      ['Night on the Town', 'Won the Night on the Town award for team collaboration (2019).'],
    ],
  },
  {
    id: 'rxss', landmark: 'rxss', years: '2020–2025',
    ...
    obstacles: [
      ...
      ['Promoted', 'Promoted to Senior Software Engineer and Technical Lead (2022).'],
      ...
      ['Hackathon 2nd', 'Took 2nd place at the RxSS Hackathon with prescriber fax automation (2022).'],
      ['Wolverine Award', 'Won the peer-nominated Wolverine Award (2022).'],
    ],
  },
  {
    id: 'fluxpilot', landmark: 'bess', years: '2022–now',
  ...
  {
    id: 'annovox', landmark: 'factory', years: '2024–now',
  ...
  {
    id: 'nac', landmark: 'capitol', years: '2025',
    ...
    obstacles: [
      ...
      ['OpenAI HQ', 'Presented at OpenAI × GitLab Foundation Demo Day at OpenAI headquarters in San Francisco.'],
      ['Mentored 4', 'Mentored 4 George Washington University master’s students in AI and RAG.'],
    ],
  },
  {
    id: 'addi', landmark: 'billboards', years: '2025–2026',
  ...
  {
    id: 'oneimaging', landmark: 'imaging', years: '2026–now',
  ...
  {
    id: 'chicago', landmark: 'chicago', years: 'Now',
    company: 'Chicago, IL', place: 'Home base',
    title: 'Where the road is today',
    blurb: 'Hackathons, awards, and the skills picked up along the way.',
    obstacles: [
      ['HackMidwest 1st', 'HackMidwest 2024: Taini, a voice AI accountability coach. 1st place, Best in AI from AWS.'],
      ['HackMidwest 3rd', 'HackMidwest 2023: CareCue, a chatbot for caregivers. 3rd place.'],
      ['Spotlight Award', 'Employee Spotlight Award for a technical talk at the CoverMyMeds conference.'],
      ['FLL mentor', 'Mentored the ICJC Mavericks First Lego League team (2023).'],
    ],
  },
];
